...
The OML Xtext grammar changed slightly, reoganizing the different relative priorities of the token parsing rules
to allow digit-leading identifiers in OML as long as the identifier contains at least one non-digit character.
