...
| Same | `class ReifiedRelationship extends ConceptualRelationship, CharacterizedEntityRelationship {...}` | `class ReifiedRelationship extends ConceptualRelationship, CharacterizedEntityRelationship {...}` |
| Same |`class ReifiedRelationshipRestriction extends ConceptualRelationship {...}` | `class ReifiedRelationshipRestriction extends ConceptualRelationship {...}` |
