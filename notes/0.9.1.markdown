...
| What the predicate pertains to | 0.9.1 concrete syntax | 0.9.0.7 concrete syntax | Change |
|---|---|---|---|
| OML `Aspect` | `<Aspect name|abbrev IRI>` | `aspect ( <Aspect name|abbrev IRI> )` | Simpler, isomorphic to OWL2 |
| OML `Concept` | `<Concept name|abbrev IRI>` | `concept ( <Concept name|abbrev IRI> )` | Simpler, isomorphic to OWL2 |
| OML `ReifiedRelationship` | `<ReifiedRelationship name|abbrev IRI>` | `reifiedRelationship ( <ReifiedRelationship name|abbrev IRI> )` | Simpler, isomorphic to OWL2 |
| OML `ReifiedRelationship.forwardProperty` | `<ReifiedRelationship.forwardProperty name|abbrev IRI>` | `property ( <ReifiedRelationship name|abbrev IRI> )` | Simpler, isomorphic to OWL2 |
| OML `ReifiedRelationship.inverseProperty` | `<ReifiedRelationship.inverseProperty name|abbrev IRI>` | `inv ( property ( <ReifiedRelationship name|abbrev IRI> ) )` | Simpler, isomorphic to OWL2 |
| OML `ReifiedRelationship.source` | `source ( <ReifiedRelationship name|abbrev IRI>` | `source ( <ReifiedRelationship name|abbrev IRI> )` | Same |
| OML `ReifiedRelationship.source` inverse | `invSource ( <ReifiedRelationship name|abbrev IRI>` | `inv ( source ( <ReifiedRelationship name|abbrev IRI> ) )` | Simpler |
| OML `ReifiedRelationship.target` | `target ( <ReifiedRelationship name|abbrev IRI>` | `target ( <ReifiedRelationship name|abbrev IRI> )` | Same |
| OML `ReifiedRelationship.target` inverse | `invTarget ( <ReifiedRelationship name|abbrev IRI>` | `inv ( target ( <ReifiedRelationship name|abbrev IRI> ) )` | Simpler |
| OML `UnreifiedRelationship` | `<UnreifiedRelationship name|abbrev IRI>` | `<UnreifiedRelationship name|abbrev IRI>` | Same, isomorphic to OWL2 |
| OML `UnreifiedRelationship` inverse | `inv ( <UnreifiedRelationship name|abbrev IRI> )` | `inv ( <UnreifiedRelationship name|abbrev IRI> )` | Same, isomorphic to OWL2 |
