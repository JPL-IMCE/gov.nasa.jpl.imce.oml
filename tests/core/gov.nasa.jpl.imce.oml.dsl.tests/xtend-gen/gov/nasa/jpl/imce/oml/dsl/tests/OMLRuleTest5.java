...
public class OMLRuleTest5 {
  ...
  public void ruleTest3() {
    final Procedure1<FormatterTestRequest> _function = (FormatterTestRequest it) -> {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("C extendsConcept B");
      _builder.newLine();
      _builder.newLine();
      _builder.append("\t");
      ...
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("C extendsConcept B");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("reifiedRelationship P {");
      _builder_1.newLine();
      _builder_1.append("\t\t\t");
      _builder_1.append("unreified=p");
      _builder_1.newLine();
      _builder_1.append("\t\t\t");
