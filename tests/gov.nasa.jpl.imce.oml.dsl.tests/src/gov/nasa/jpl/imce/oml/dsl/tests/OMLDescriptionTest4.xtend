...
class OMLDescriptionTest4 {
	...
	def void test() {
		...
		val r1 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest4A.oml"))
		val Extent e1 = commonF.createExtent()
		r1.getContents.add(e1)

		val TerminologyGraph g = graphsF.createTerminologyGraph()
		g.extent = e1
		g.iri = "http://www.example.org/OMLDescriptionTest4A"

		val Concept c = terminologiesF.createConcept
		c.tbox = g
		c.name = "Box"
		
		val Concept d = terminologiesF.createConcept
		d.tbox = g
		d.name = "Boite"
		
		val UnreifiedRelationship r = terminologiesF.createUnreifiedRelationship
		r.tbox = g
		r.name = "translation"
		r.source = c
		r.target = d
		...
		val String expected1 = '''
			open terminology <http://www.example.org/OMLDescriptionTest4A> {
			
				concept Box
			
				concept Boite
			
				unreifiedRelationship translation {
					source = Box
					target = Boite }
		...
		val r2 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest4B.oml"))
		val Extent e2 = commonF.createExtent()
		r2.getContents.add(e2)
		
		val DescriptionBox db = descriptionsF.createDescriptionBox
		db.extent = e2
		db.iri = "http://www.example.org/OMLDescriptionTest4B"
		...
		val ConceptInstance di = descriptionsF.createConceptInstance
		di.descriptionBox = db
		di.name = "boite0"
		di.singletonConceptClassifier = d
		
		val ConceptInstance dj = descriptionsF.createConceptInstance
		dj.descriptionBox = db
		dj.name = "boite1"
		dj.singletonConceptClassifier = d
		...
		val i0 = descriptionsF.createInstanceRelationshipEnumerationRestriction
		i0.descriptionBox = db
		i0.domain = ci
		i0.restrictedRelationship = r
		
		val o0 = descriptionsF.createInstanceRelationshipOneOfRestriction
		o0.enumeration = i0
		o0.range = di
		
		val o1 = descriptionsF.createInstanceRelationshipOneOfRestriction
		o1.enumeration = i0
		o1.range = dj
		
		val i1 = descriptionsF.createInstanceRelationshipExistentialRangeRestriction
		i1.descriptionBox = db
		i1.domain = ci
		i1.restrictedRelationship = r
		i1.range = d
		
		val i2 = descriptionsF.createInstanceRelationshipUniversalRangeRestriction
		i2.descriptionBox = db
		i2.domain = ci
		i2.restrictedRelationship = r
		i2.range = d
		
		val String text2 = serialize(r2)
		val String expected2 =
		'''
		final descriptionBox <http://www.example.org/OMLDescriptionTest4B> {
		
			extends <http://www.example.org/OMLDescriptionTest4A>
		
			conceptInstance(box0 is-a OMLDescriptionTest4A:Box)
		
			conceptInstance(boite0 is-a OMLDescriptionTest4A:Boite)
		
			conceptInstance(boite1 is-a OMLDescriptionTest4A:Boite)
		
			box0.OMLDescriptionTest4A:translation in {
				boite0
				boite1
			}
		
			someEntities box0.OMLDescriptionTest4A:translation in OMLDescriptionTest4A:Boite
		
			allEntities OMLDescriptionTest4B:box0.OMLDescriptionTest4A:translation in OMLDescriptionTest4A:Boite
		
			box0 . OMLDescriptionTest4A:name = "box #0" ^^ OMLDescriptionTest4A:NonEmptyString
		
			box0 . OMLDescriptionTest4A:length = 123.45 ^^ OMLDescriptionTest4A:PositiveDouble
		
			box0 . OMLDescriptionTest4A:isSmall = false
