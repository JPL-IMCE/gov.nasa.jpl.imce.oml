...
class OMLDescriptionTest5 {
	...
	def void test() {
		...
		val ReifiedRelationship cd = terminologiesF.createReifiedRelationship
		cd.tbox = g
		cd.name = "Box2Boite"
		cd.source = c
		cd.target = d
		
		val cdf = terminologiesF.createForwardProperty
		cdf.name = "box2boite"
		cd.forwardProperty = cdf
		...
		val ReifiedRelationshipInstance cdi = descriptionsF.createReifiedRelationshipInstance
		cdi.name = "box02boite0"
		cdi.descriptionBox = db
		cdi.singletonConceptualRelationshipClassifier = cd
		...
		final descriptionBox <http://www.example.org/OMLDescriptionTest1B> {
			...
			conceptInstance(box0 is-a OMLDescriptionTest1A:Box)
		
			conceptInstance(boite0 is-a OMLDescriptionTest1A:Boite)
		
			reifiedRelationshipInstance(box02boite0 is-a OMLDescriptionTest1A:Box2Boite)
		
			box0 . OMLDescriptionTest1A:name = "box #0"
		
			box0 . OMLDescriptionTest1A:length = 123.45
		
			box0 . OMLDescriptionTest1A:isSmall = false
