...
class OMLDescriptionTest3 {
	...
	def void test() {
		...
		val r1 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest3A.oml"))
		val Extent e1 = commonF.createExtent()
		r1.getContents.add(e1)

		val TerminologyGraph g = graphsF.createTerminologyGraph()
		g.extent = e1
		g.iri = "http://www.example.org/OMLDescriptionTest3A"
		...
		val String expected1 = '''
			open terminology <http://www.example.org/OMLDescriptionTest3A> {
		...
		val r2 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest3B.oml"))
		val Extent e2 = commonF.createExtent()
		r2.getContents.add(e2)
		
		val DescriptionBox db = descriptionsF.createDescriptionBox
		db.extent = e2
		db.iri = "http://www.example.org/OMLDescriptionTest3B"
		...
		val i0 = descriptionsF.createInstanceRelationshipValueRestriction
		...
		'''
		final descriptionBox <http://www.example.org/OMLDescriptionTest3B> {
		
			extends <http://www.example.org/OMLDescriptionTest3A>
		
			conceptInstance(box0 is-a OMLDescriptionTest3A:Box)
		
			conceptInstance(boite0 is-a OMLDescriptionTest3A:Boite)
		
			box0.OMLDescriptionTest3A:translation = boite0
		
			someEntities box0.OMLDescriptionTest3A:translation in OMLDescriptionTest3A:Boite
		
			allEntities OMLDescriptionTest3B:box0.OMLDescriptionTest3A:translation in OMLDescriptionTest3A:Boite
		
			box0 . OMLDescriptionTest3A:name = "box #0" ^^ OMLDescriptionTest3A:NonEmptyString
		
			box0 . OMLDescriptionTest3A:length = 123.45 ^^ OMLDescriptionTest3A:PositiveDouble
		
			box0 . OMLDescriptionTest3A:isSmall = false
