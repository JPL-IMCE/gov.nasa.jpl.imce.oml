...
public class OMLDescriptionTest4 {
  @Inject
  ...
  public void test() {
    ...
    final Resource r1 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest4A.oml"));
    ...
    g.setExtent(e1);
    g.setIri("http://www.example.org/OMLDescriptionTest4A");
    ...
    _builder.append("open terminology <http://www.example.org/OMLDescriptionTest4A> {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    final Resource r2 = rs.createResource(URI.createFileURI("file:OMLDescriptionTest4B.oml"));
    ...
    db.setExtent(e2);
    db.setIri("http://www.example.org/OMLDescriptionTest4B");
    ...
    final ConceptInstance dj = this.descriptionsF.createConceptInstance();
    dj.setDescriptionBox(db);
    dj.setName("boite1");
    dj.setSingletonConceptClassifier(d);
    ...
    final InstanceRelationshipEnumerationRestriction i0 = this.descriptionsF.createInstanceRelationshipEnumerationRestriction();
    i0.setDescriptionBox(db);
    i0.setDomain(ci);
    i0.setRestrictedRelationship(r);
    final InstanceRelationshipOneOfRestriction o0 = this.descriptionsF.createInstanceRelationshipOneOfRestriction();
    o0.setEnumeration(i0);
    o0.setRange(di);
    final InstanceRelationshipOneOfRestriction o1 = this.descriptionsF.createInstanceRelationshipOneOfRestriction();
    o1.setEnumeration(i0);
    o1.setRange(dj);
    ...
    _builder_1.append("final descriptionBox <http://www.example.org/OMLDescriptionTest4B> {");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("extends <http://www.example.org/OMLDescriptionTest4A>");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("conceptInstance(box0 is-a OMLDescriptionTest4A:Box)");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("conceptInstance(boite0 is-a OMLDescriptionTest4A:Boite)");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("conceptInstance(boite1 is-a OMLDescriptionTest4A:Boite)");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("box0.OMLDescriptionTest4A:translation in {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("boite0");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("boite1");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("someEntities box0.OMLDescriptionTest4A:translation in OMLDescriptionTest4A:Boite");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("allEntities OMLDescriptionTest4B:box0.OMLDescriptionTest4A:translation in OMLDescriptionTest4A:Boite");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("box0 . OMLDescriptionTest4A:name = \"box #0\" ^^ OMLDescriptionTest4A:NonEmptyString");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("box0 . OMLDescriptionTest4A:length = 123.45 ^^ OMLDescriptionTest4A:PositiveDouble");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("box0 . OMLDescriptionTest4A:isSmall = false");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("}");
    _builder_1.newLine();
