...
public class OMLZip1Test extends OMLSaveLoadComparisonTest {
  public static Pair<URI, Extent>[] example1() {
    ...
    final Scalar scalar1 = OMLSaveLoadComparisonTest._terminologiesFactory.createScalar();
    scalar1.setName("integer");
    scalar1.setTbox(tbox1);
    final EntityScalarDataProperty scalarDP1 = OMLSaveLoadComparisonTest._terminologiesFactory.createEntityScalarDataProperty();
    scalarDP1.setName("p1");
    scalarDP1.setDomain(concept1);
    scalarDP1.setRange(scalar1);
    scalarDP1.setTbox(tbox1);
    scalarDP1.setIsIdentityCriteria(true);
    final EntityScalarDataProperty scalarDP2 = OMLSaveLoadComparisonTest._terminologiesFactory.createEntityScalarDataProperty();
    scalarDP2.setName("p2");
    scalarDP2.setDomain(concept1);
    scalarDP2.setRange(scalar1);
    scalarDP2.setTbox(tbox1);
    scalarDP2.setIsIdentityCriteria(false);
