...
class OMLZip6Test extends MixedOMLSaveLoadComparisonTest {
	...
	def Pair<URI,Extent>[] example1() {
        ...
        val rel12 = createUnreifiedRelationship
        rel12.tbox = tbox2
        rel12.name = "rel12"
        rel12.source = concept1
        rel12.target = concept2
        
        val concept3 = createCardinalityRestrictedConcept
        concept3.tbox = tbox2
        concept3.name = "Concept3"
        concept3.restrictedRelationship = rel12
        concept3.restrictedRange = concept2
        concept3.restrictionKind = CardinalityRestrictionKind.MIN
        concept3.restrictedCardinality = new PositiveIntegerValue("2")
