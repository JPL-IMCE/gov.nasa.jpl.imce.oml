		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReifiedRelationshipRestriction_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReifiedRelationshipRestriction_source_feature", "_UI_ReifiedRelationshipRestriction_type"),
				 TerminologiesPackage.Literals.REIFIED_RELATIONSHIP_RESTRICTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReifiedRelationshipRestriction_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReifiedRelationshipRestriction_target_feature", "_UI_ReifiedRelationshipRestriction_type"),
				 TerminologiesPackage.Literals.REIFIED_RELATIONSHIP_RESTRICTION__TARGET,
				 true,
				 false,
				 true,
				 null,
