		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnreifiedRelationship_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnreifiedRelationship_source_feature", "_UI_UnreifiedRelationship_type"),
				 TerminologiesPackage.Literals.UNREIFIED_RELATIONSHIP__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UnreifiedRelationship_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UnreifiedRelationship_target_feature", "_UI_UnreifiedRelationship_type"),
				 TerminologiesPackage.Literals.UNREIFIED_RELATIONSHIP__TARGET,
				 true,
				 false,
				 true,
				 null,
