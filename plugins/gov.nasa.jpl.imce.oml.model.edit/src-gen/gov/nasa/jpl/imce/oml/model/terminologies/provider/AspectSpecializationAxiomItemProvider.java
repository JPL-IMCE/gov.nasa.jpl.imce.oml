...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.terminologies.AspectSpecializationAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TerminologiesPackage.Literals.ASPECT_SPECIALIZATION_AXIOM__SUB_ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TerminologiesPackage.Literals.ASPECT_SPECIALIZATION_AXIOM__SUPER_ASPECT,
				 true,
				 false,
				 true,
				 null,
