 ...
 * @generated
 */
public class ConceptualRelationshipItemProvider extends ConceptualEntityItemProvider {
	/**
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ConceptualRelationship_type") :
			getString("_UI_ConceptualRelationship_type") + " " + label;
	}
