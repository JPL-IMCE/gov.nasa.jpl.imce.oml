...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.common.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider extends ResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_extent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_extent_feature", "_UI_Module_type"),
				 CommonPackage.Literals.MODULE__EXTENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonPackage.Literals.MODULE__IRI,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CommonPackage.Literals.MODULE__ANNOTATION_PROPERTIES);
		}
	...
	public String getText(Object object) {
		String label = ((gov.nasa.jpl.imce.oml.model.common.Module)object).getUuid();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(gov.nasa.jpl.imce.oml.model.common.Module.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CommonPackage.Literals.MODULE__ANNOTATION_PROPERTIES,
