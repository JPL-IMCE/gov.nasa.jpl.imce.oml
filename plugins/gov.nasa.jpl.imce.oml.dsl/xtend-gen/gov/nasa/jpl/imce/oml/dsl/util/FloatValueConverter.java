...
public class FloatValueConverter extends GenericValueConverter<FloatValue> {
  @Inject
  protected IValueConverterService valueConverterService;
  
  @Override
  public String toEscapedString(final FloatValue value) {
    return value.value;
  }
  
  @Override
  public FloatValue toValue(final String string, final INode node) throws ValueConverterException {
