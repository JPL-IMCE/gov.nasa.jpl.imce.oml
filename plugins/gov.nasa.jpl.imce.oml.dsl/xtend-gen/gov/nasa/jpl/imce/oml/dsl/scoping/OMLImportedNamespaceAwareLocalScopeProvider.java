...
public class OMLImportedNamespaceAwareLocalScopeProvider extends ImportedNamespaceAwareLocalScopeProvider {
  ...
  public IScope getScope(final EObject context, final EReference reference) {
    IScope _xblockexpression = null;
    {
      ...
      if (!_matched) {
        if (context instanceof ReifiedRelationship) {
          _matched=true;
          if ((Objects.equal(reference, TerminologiesPackage.eINSTANCE.getReifiedRelationship_Source()) || 
            Objects.equal(reference, TerminologiesPackage.eINSTANCE.getReifiedRelationship_Target()))) {
            scope = this._oMLScopeExtensions.allEntitiesScope(((ReifiedRelationship)context).getTbox());
          }
        }
      }
      if (!_matched) {
        if (context instanceof ReifiedRelationshipRestriction) {
          _matched=true;
          if ((Objects.equal(reference, TerminologiesPackage.eINSTANCE.getReifiedRelationshipRestriction_Source()) || 
            Objects.equal(reference, TerminologiesPackage.eINSTANCE.getReifiedRelationshipRestriction_Target()))) {
            scope = this._oMLScopeExtensions.allEntitiesScope(((ReifiedRelationshipRestriction)context).getTbox());
          }
        }
      }
      if (!_matched) {
        if (context instanceof UnreifiedRelationship) {
          _matched=true;
          if ((Objects.equal(reference, TerminologiesPackage.eINSTANCE.getUnreifiedRelationship_Source()) || 
            Objects.equal(reference, TerminologiesPackage.eINSTANCE.getUnreifiedRelationship_Target()))) {
            scope = this._oMLScopeExtensions.allEntitiesScope(((UnreifiedRelationship)context).getTbox());
          }
        }
      }
      if (!_matched) {
      ...
      if (!_matched) {
        if (context instanceof ReifiedRelationshipSpecializationAxiom) {
          ...
          if (_equals) {
            scope = this._oMLScopeExtensions.allConceptualRelationshipsScope(((ReifiedRelationshipSpecializationAxiom)context).getTbox());
          } else {
      ...
      if (!_matched) {
        if (context instanceof InstanceRelationshipValueRestriction) {
          _matched=true;
          EReference _instanceRelationshipValueRestriction_Domain = DescriptionsPackage.eINSTANCE.getInstanceRelationshipValueRestriction_Domain();
          boolean _equals = Objects.equal(reference, _instanceRelationshipValueRestriction_Domain);
          if (_equals) {
            DescriptionBox _descriptionBox = ((InstanceRelationshipValueRestriction)context).descriptionBox();
            IScope _allConceptualEntitySingletonInstanceScope = null;
            if (_descriptionBox!=null) {
              _allConceptualEntitySingletonInstanceScope=this._oMLScopeExtensions.allConceptualEntitySingletonInstanceScope(_descriptionBox);
            }
            ...
            EReference _instanceRelationshipValueRestriction_Range = DescriptionsPackage.eINSTANCE.getInstanceRelationshipValueRestriction_Range();
            boolean _equals_1 = Objects.equal(reference, _instanceRelationshipValueRestriction_Range);
            if (_equals_1) {
              DescriptionBox _descriptionBox_1 = ((InstanceRelationshipValueRestriction)context).descriptionBox();
              IScope _allConceptualEntitySingletonInstanceScope_1 = null;
              if (_descriptionBox_1!=null) {
                _allConceptualEntitySingletonInstanceScope_1=this._oMLScopeExtensions.allConceptualEntitySingletonInstanceScope(_descriptionBox_1);
              }
              scope = _allConceptualEntitySingletonInstanceScope_1;
            } else {
              EReference _instanceRelationshipValueRestriction_RestrictedRelationship = DescriptionsPackage.eINSTANCE.getInstanceRelationshipValueRestriction_RestrictedRelationship();
