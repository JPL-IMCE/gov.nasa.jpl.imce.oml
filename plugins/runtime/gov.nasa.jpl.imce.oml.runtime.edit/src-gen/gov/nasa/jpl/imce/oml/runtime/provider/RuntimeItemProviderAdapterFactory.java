...
import gov.nasa.jpl.imce.oml.runtime.util.RuntimeAdapterFactory;
...
public class RuntimeItemProviderAdapterFactory extends RuntimeAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link gov.nasa.jpl.imce.oml.runtime.OMLScalar} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected OMLScalarItemProvider omlScalarItemProvider;

	/**
	 * This creates an adapter for a {@link gov.nasa.jpl.imce.oml.runtime.OMLScalar}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createOMLScalarAdapter() {
		if (omlScalarItemProvider == null) {
			omlScalarItemProvider = new OMLScalarItemProvider(this);
		}

		return omlScalarItemProvider;
	}
	...
	public void dispose() {
		...
		if (omlScalarItemProvider != null) omlScalarItemProvider.dispose();
