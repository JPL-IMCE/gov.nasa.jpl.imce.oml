...
public class RuntimeFactoryImpl extends EFactoryImpl implements RuntimeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case RuntimePackage.OML_SCALAR: return (EObject)createOMLScalar();
			case RuntimePackage.OML_ASPECT: return (EObject)createOMLAspect();
	 ...
	 * @generated
	 */
	public OMLScalar createOMLScalar() {
		OMLScalarImpl omlScalar = new OMLScalarImpl();
		return omlScalar;
	}
