...
public class RuntimeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RuntimePackage.OML_SCALAR: {
				OMLScalar omlScalar = (OMLScalar)theEObject;
				T result = caseOMLScalar(omlScalar);
				if (result == null) result = caseOMLObject(omlScalar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case RuntimePackage.OML_ASPECT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OML Scalar</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OML Scalar</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOMLScalar(OMLScalar object) {
		return null;
	}
