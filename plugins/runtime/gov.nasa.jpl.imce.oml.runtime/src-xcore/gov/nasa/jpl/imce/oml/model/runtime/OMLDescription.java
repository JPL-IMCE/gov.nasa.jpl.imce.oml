 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.runtime.OMLDescription#getOmlDesciptionIRI <em>Oml Desciption IRI</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.runtime.OMLDescription#getOmlDescriptionContents <em>Oml Description Contents</em>}</li>
 * </ul>
 *
 * @see gov.nasa.jpl.imce.oml.model.runtime.RuntimePackage#getOMLDescription()
 * @model
 * @generated
 */
public interface OMLDescription extends OMLObject {
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.runtime.RuntimePackage#getOMLDescription_OmlDesciptionIRI()
	 * @model unique="false" dataType="gov.nasa.jpl.imce.oml.model.runtime.IRI"
	 * @generated
	 */
	String getOmlDesciptionIRI();

	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.runtime.OMLDescription#getOmlDesciptionIRI <em>Oml Desciption IRI</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link gov.nasa.jpl.imce.oml.model.runtime.OMLObject}.
	 * It is bidirectional and its opposite is '{@link gov.nasa.jpl.imce.oml.model.runtime.OMLObject#getOmlRoot <em>Oml Root</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.runtime.RuntimePackage#getOMLDescription_OmlDescriptionContents()
