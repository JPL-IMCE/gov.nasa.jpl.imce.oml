...
public class RuntimePackageImpl extends EPackageImpl implements RuntimePackage {
	 ...
	 * @generated
	 */
	private EClass omlScalarEClass = null;
	 ...
	 * @see gov.nasa.jpl.imce.oml.runtime.RuntimePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getOMLScalar() {
		return omlScalarEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getOMLScalar_Value() {
		return (EAttribute)omlScalarEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		omlScalarEClass = createEClass(OML_SCALAR);
		createEAttribute(omlScalarEClass, OML_SCALAR__VALUE);
	...
	public void initializePackageContents() {
		...
		omlScalarEClass.getESuperTypes().add(this.getOMLObject());
		...
		initEClass(omlScalarEClass, OMLScalar.class, "OMLScalar", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getOMLScalar_Value(), theEcorePackage.getEString(), "value", null, 0, 1, OMLScalar.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
