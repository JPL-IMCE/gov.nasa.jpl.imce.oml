 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.runtime.impl.OMLRelationshipFromStructureImpl#getOmlSource <em>Oml Source</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OMLRelationshipFromStructureImpl extends OMLObjectImpl implements OMLRelationshipFromStructure {
	...
	protected EClass eStaticClass() {
		return RuntimePackage.Literals.OML_RELATIONSHIP_FROM_STRUCTURE;
	}
		...
		if (omlSource != null && ((EObject)omlSource).eIsProxy()) {
			...
			if (omlSource != oldOmlSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RuntimePackage.OML_RELATIONSHIP_FROM_STRUCTURE__OML_SOURCE, oldOmlSource, omlSource));
			}
		}
		return omlSource;
	}
	...
	public void setOmlSource(OMLStructure newOmlSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RuntimePackage.OML_RELATIONSHIP_FROM_STRUCTURE__OML_SOURCE, oldOmlSource, omlSource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RuntimePackage.OML_RELATIONSHIP_FROM_STRUCTURE__OML_SOURCE:
