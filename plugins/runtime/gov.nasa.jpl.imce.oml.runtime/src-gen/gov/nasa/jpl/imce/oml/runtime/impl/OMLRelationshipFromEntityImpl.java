...
public abstract class OMLRelationshipFromEntityImpl extends OMLObjectImpl implements OMLRelationshipFromEntity {
	...
	protected EClass eStaticClass() {
		return OMLRuntimePackage.Literals.OML_RELATIONSHIP_FROM_ENTITY;
	}
		...
		if (omlSource != null && ((EObject)omlSource).eIsProxy()) {
			...
			if (omlSource != oldOmlSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OMLRuntimePackage.OML_RELATIONSHIP_FROM_ENTITY__OML_SOURCE, oldOmlSource, omlSource));
			}
		}
		return omlSource;
	}
	...
	public void setOmlSource(OMLEntity newOmlSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMLRuntimePackage.OML_RELATIONSHIP_FROM_ENTITY__OML_SOURCE, oldOmlSource, omlSource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OMLRuntimePackage.OML_RELATIONSHIP_FROM_ENTITY__OML_SOURCE:
