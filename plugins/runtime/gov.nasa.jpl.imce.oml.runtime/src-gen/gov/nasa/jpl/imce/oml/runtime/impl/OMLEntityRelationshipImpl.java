 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.runtime.impl.OMLEntityRelationshipImpl#getOmlTarget <em>Oml Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OMLEntityRelationshipImpl extends OMLRelationshipFromEntityImpl implements OMLEntityRelationship {
	...
	protected EClass eStaticClass() {
		return OMLRuntimePackage.Literals.OML_ENTITY_RELATIONSHIP;
	}
		...
		if (omlTarget != null && ((EObject)omlTarget).eIsProxy()) {
			...
			if (omlTarget != oldOmlTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OMLRuntimePackage.OML_ENTITY_RELATIONSHIP__OML_TARGET, oldOmlTarget, omlTarget));
			}
		}
		return omlTarget;
	}
	...
	public void setOmlTarget(OMLEntity newOmlTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMLRuntimePackage.OML_ENTITY_RELATIONSHIP__OML_TARGET, oldOmlTarget, omlTarget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OMLRuntimePackage.OML_ENTITY_RELATIONSHIP__OML_TARGET:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == OMLRelationshipToEntity.class) {
			switch (derivedFeatureID) {
				case OMLRuntimePackage.OML_ENTITY_RELATIONSHIP__OML_TARGET: return OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY__OML_TARGET;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == OMLRelationshipToEntity.class) {
			switch (baseFeatureID) {
				case OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY__OML_TARGET: return OMLRuntimePackage.OML_ENTITY_RELATIONSHIP__OML_TARGET;
				default: return -1;
			}
		}
