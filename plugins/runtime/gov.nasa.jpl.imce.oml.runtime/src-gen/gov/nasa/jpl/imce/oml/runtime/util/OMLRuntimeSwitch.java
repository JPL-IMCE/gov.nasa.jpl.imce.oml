...
public class OMLRuntimeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OMLRuntimePackage.OML_RELATIONSHIP_FROM_ENTITY: {
			...
			case OMLRuntimePackage.OML_RELATIONSHIP_FROM_STRUCTURE: {
			...
			case OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY: {
			...
			case OMLRuntimePackage.OML_RELATIONSHIP_TO_STRUCTURE: {
			...
			case OMLRuntimePackage.OML_ENTITY_RELATIONSHIP: {
			...
			case OMLRuntimePackage.OML_UNREIFIED_RELATIONSHIP: {
			...
			case OMLRuntimePackage.OML_ENTITY_DATA_PROPERTY_TO_SCALAR: {
			...
			case OMLRuntimePackage.OML_ENTITY_DATA_PROPERTY_TO_STRUCTURE: {
			...
			case OMLRuntimePackage.OML_STRUCTURE_DATA_PROPERTY_TO_SCALAR: {
			...
			case OMLRuntimePackage.OML_STRUCTURE_DATA_PROPERTY_TO_STRUCTURE: {
