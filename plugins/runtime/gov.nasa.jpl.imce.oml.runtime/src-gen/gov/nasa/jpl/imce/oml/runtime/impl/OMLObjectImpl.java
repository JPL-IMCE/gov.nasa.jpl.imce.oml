 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.runtime.impl.OMLObjectImpl#getOmlRoot <em>Oml Root</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OMLObjectImpl extends CDOObjectImpl implements OMLObject {
	...
	public OMLDescription getOmlRoot() {
		if (eContainerFeatureID() != OMLRuntimePackage.OML_OBJECT__OML_ROOT) return null;
	...
	public NotificationChain basicSetOmlRoot(OMLDescription newOmlRoot, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOmlRoot, OMLRuntimePackage.OML_OBJECT__OML_ROOT, msgs);
		return msgs;
	}
	...
	public void setOmlRoot(OMLDescription newOmlRoot) {
		if (newOmlRoot != eInternalContainer() || (eContainerFeatureID() != OMLRuntimePackage.OML_OBJECT__OML_ROOT && newOmlRoot != null)) {
			...
			if (newOmlRoot != null)
				msgs = ((InternalEObject)newOmlRoot).eInverseAdd(this, OMLRuntimePackage.OML_DESCRIPTION__OML_DESCRIPTION_CONTENTS, OMLDescription.class, msgs);
			msgs = basicSetOmlRoot(newOmlRoot, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMLRuntimePackage.OML_OBJECT__OML_ROOT, newOmlRoot, newOmlRoot));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OMLRuntimePackage.OML_OBJECT__OML_ROOT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case OMLRuntimePackage.OML_OBJECT__OML_ROOT:
				return eInternalContainer().eInverseRemove(this, OMLRuntimePackage.OML_DESCRIPTION__OML_DESCRIPTION_CONTENTS, OMLDescription.class, msgs);
		}
