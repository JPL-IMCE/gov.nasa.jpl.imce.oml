 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.runtime.impl.OMLRelationshipToStructureImpl#getOmlTarget <em>Oml Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OMLRelationshipToStructureImpl extends OMLObjectImpl implements OMLRelationshipToStructure {
	 ...
	 * @generated
	 */
	protected OMLRelationshipToStructureImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OMLRuntimePackage.Literals.OML_RELATIONSHIP_TO_STRUCTURE;
	}
		...
		if (omlTarget != null && ((EObject)omlTarget).eIsProxy()) {
			...
			if (omlTarget != oldOmlTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OMLRuntimePackage.OML_RELATIONSHIP_TO_STRUCTURE__OML_TARGET, oldOmlTarget, omlTarget));
			}
		}
		return omlTarget;
	}
	...
	public void setOmlTarget(OMLStructure newOmlTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMLRuntimePackage.OML_RELATIONSHIP_TO_STRUCTURE__OML_TARGET, oldOmlTarget, omlTarget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OMLRuntimePackage.OML_RELATIONSHIP_TO_STRUCTURE__OML_TARGET:
