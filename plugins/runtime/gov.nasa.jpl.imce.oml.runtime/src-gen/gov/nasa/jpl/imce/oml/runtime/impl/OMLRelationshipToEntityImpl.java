...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>OML Relationship To Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.runtime.impl.OMLRelationshipToEntityImpl#getOmlTarget <em>Oml Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class OMLRelationshipToEntityImpl extends OMLObjectImpl implements OMLRelationshipToEntity {
	/**
	 ...
	 * @generated
	 */
	protected OMLRelationshipToEntityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OMLRuntimePackage.Literals.OML_RELATIONSHIP_TO_ENTITY;
	}
		...
		if (omlTarget != null && ((EObject)omlTarget).eIsProxy()) {
			...
			if (omlTarget != oldOmlTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY__OML_TARGET, oldOmlTarget, omlTarget));
			}
		}
		return omlTarget;
	}
	...
	public void setOmlTarget(OMLEntity newOmlTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY__OML_TARGET, oldOmlTarget, omlTarget));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OMLRuntimePackage.OML_RELATIONSHIP_TO_ENTITY__OML_TARGET:
