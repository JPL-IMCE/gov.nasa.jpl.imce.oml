...
public class CommonPackageImpl extends EPackageImpl implements CommonPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(moduleEClass, gov.nasa.jpl.imce.oml.model.common.Module.class, "Module", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModule_AnnotationProperties(), this.getAnnotationProperty(), this.getAnnotationProperty_Module(), "annotationProperties", null, 0, -1, gov.nasa.jpl.imce.oml.model.common.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModule_Extent(), this.getExtent(), this.getExtent_Modules(), "extent", null, 1, 1, gov.nasa.jpl.imce.oml.model.common.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModule_Iri(), this.getIRI(), "iri", null, 1, 1, gov.nasa.jpl.imce.oml.model.common.Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
