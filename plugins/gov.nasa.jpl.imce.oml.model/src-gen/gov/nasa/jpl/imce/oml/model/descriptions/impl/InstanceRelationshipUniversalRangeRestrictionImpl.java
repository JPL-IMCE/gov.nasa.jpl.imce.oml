...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Instance Relationship Universal Range Restriction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.impl.InstanceRelationshipUniversalRangeRestrictionImpl#getDescriptionBox <em>Description Box</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.impl.InstanceRelationshipUniversalRangeRestrictionImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.impl.InstanceRelationshipUniversalRangeRestrictionImpl#getRestrictedRelationship <em>Restricted Relationship</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.impl.InstanceRelationshipUniversalRangeRestrictionImpl#getRange <em>Range</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceRelationshipUniversalRangeRestrictionImpl extends TerminologyInstanceAssertionImpl implements InstanceRelationshipUniversalRangeRestriction {
	/**
	 ...
	 * @generated
	 */
	protected InstanceRelationshipUniversalRangeRestrictionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DescriptionsPackage.Literals.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION;
	}
	...
	public DescriptionBox getDescriptionBox() {
		if (eContainerFeatureID() != DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX) return null;
	...
	public NotificationChain basicSetDescriptionBox(DescriptionBox newDescriptionBox, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDescriptionBox, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX, msgs);
		return msgs;
	}
	...
	public void setDescriptionBox(DescriptionBox newDescriptionBox) {
		if (newDescriptionBox != eInternalContainer() || (eContainerFeatureID() != DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX && newDescriptionBox != null)) {
			...
			if (newDescriptionBox != null)
				msgs = ((InternalEObject)newDescriptionBox).eInverseAdd(this, DescriptionsPackage.DESCRIPTION_BOX__INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTIONS, DescriptionBox.class, msgs);
			msgs = basicSetDescriptionBox(newDescriptionBox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX, newDescriptionBox, newDescriptionBox));
	}
		...
		if (domain != null && domain.eIsProxy()) {
			...
			if (domain != oldDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DOMAIN, oldDomain, domain));
			}
		}
		return domain;
	}
	...
	public void setDomain(ConceptualEntitySingletonInstance newDomain) {
		...
		domain = newDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DOMAIN, oldDomain, domain));
	}
	...
	public RestrictableRelationship getRestrictedRelationship() {
		if (restrictedRelationship != null && restrictedRelationship.eIsProxy()) {
			...
			if (restrictedRelationship != oldRestrictedRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RESTRICTED_RELATIONSHIP, oldRestrictedRelationship, restrictedRelationship));
			}
		}
	...
	public void setRestrictedRelationship(RestrictableRelationship newRestrictedRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RESTRICTED_RELATIONSHIP, oldRestrictedRelationship, restrictedRelationship));
	}
	...
	public Entity getRange() {
		if (range != null && range.eIsProxy()) {
			...
			if (range != oldRange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RANGE, oldRange, range));
			}
		}
		return range;
	}
	...
	public void setRange(Entity newRange) {
		...
		range = newRange;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RANGE, oldRange, range));
	}
	...
	public String uuid() {
		...
		UUID _derivedUUID = OMLExtensions.derivedUUID(
			"InstanceRelationshipUniversalRangeRestriction", _mappedTo, _mappedTo_1, _mappedTo_2, _mappedTo_3);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DESCRIPTION_BOX:
				return eInternalContainer().eInverseRemove(this, DescriptionsPackage.DESCRIPTION_BOX__INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTIONS, DescriptionBox.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__DOMAIN:
				if (resolve) return getDomain();
				return basicGetDomain();
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RESTRICTED_RELATIONSHIP:
				if (resolve) return getRestrictedRelationship();
				return basicGetRestrictedRelationship();
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION__RANGE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION___DESCRIPTION_BOX:
				return descriptionBox();
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION___UUID:
				return uuid();
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION___MODULE_CONTEXT:
				return moduleContext();
			case DescriptionsPackage.INSTANCE_RELATIONSHIP_UNIVERSAL_RANGE_RESTRICTION___ALL_NESTED_ELEMENTS:
				return allNestedElements();
		}
		return super.eInvoke(operationID, arguments);
	}

} //InstanceRelationshipUniversalRangeRestrictionImpl
