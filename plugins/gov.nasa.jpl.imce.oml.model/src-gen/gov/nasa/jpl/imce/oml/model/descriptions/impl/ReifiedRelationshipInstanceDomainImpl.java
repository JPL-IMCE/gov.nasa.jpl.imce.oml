	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case DescriptionsPackage.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN___UUID:
				return uuid();
			case DescriptionsPackage.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN___MODULE_CONTEXT:
				return moduleContext();
			case DescriptionsPackage.REIFIED_RELATIONSHIP_INSTANCE_DOMAIN___ALL_NESTED_ELEMENTS:
