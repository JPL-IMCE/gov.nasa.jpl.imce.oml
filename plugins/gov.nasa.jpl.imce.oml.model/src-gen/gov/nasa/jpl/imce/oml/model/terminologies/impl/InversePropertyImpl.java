 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.InversePropertyImpl#getReifiedRelationship <em>Reified Relationship</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.InversePropertyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InversePropertyImpl extends RestrictableRelationshipImpl implements InverseProperty {
	/**
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.INVERSE_PROPERTY;
	}
	...
	public ReifiedRelationship getReifiedRelationship() {
		if (eContainerFeatureID() != TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP) return null;
	...
	public NotificationChain basicSetReifiedRelationship(ReifiedRelationship newReifiedRelationship, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newReifiedRelationship, TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP, msgs);
		return msgs;
	}
	...
	public void setReifiedRelationship(ReifiedRelationship newReifiedRelationship) {
		if (newReifiedRelationship != eInternalContainer() || (eContainerFeatureID() != TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP && newReifiedRelationship != null)) {
			if (EcoreUtil.isAncestor(this, newReifiedRelationship))
				throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
			if (newReifiedRelationship != null)
				msgs = ((InternalEObject)newReifiedRelationship).eInverseAdd(this, TerminologiesPackage.REIFIED_RELATIONSHIP__INVERSE_PROPERTY, ReifiedRelationship.class, msgs);
			msgs = basicSetReifiedRelationship(newReifiedRelationship, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP, newReifiedRelationship, newReifiedRelationship));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.INVERSE_PROPERTY__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TerminologiesPackage.INVERSE_PROPERTY__REIFIED_RELATIONSHIP:
				return eInternalContainer().eInverseRemove(this, TerminologiesPackage.REIFIED_RELATIONSHIP__INVERSE_PROPERTY, ReifiedRelationship.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TerminologiesPackage.INVERSE_PROPERTY__NAME:
				return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.INVERSE_PROPERTY___IRI:
				return iri();
			case TerminologiesPackage.INVERSE_PROPERTY___ABBREV_IRI:
				return abbrevIRI();
			case TerminologiesPackage.INVERSE_PROPERTY___NAME:
				return name();
			case TerminologiesPackage.INVERSE_PROPERTY___UUID:
				return uuid();
