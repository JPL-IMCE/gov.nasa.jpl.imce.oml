...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Instance Relationship Universal Range Restriction</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getDescriptionBox <em>Description Box</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getDomain <em>Domain</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getRestrictedRelationship <em>Restricted Relationship</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getRange <em>Range</em>}</li>
 * </ul>
 *
 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipUniversalRangeRestriction()
 * @model
 * @generated
 */
public interface InstanceRelationshipUniversalRangeRestriction extends TerminologyInstanceAssertion, ElementCrossReferenceTuple {
	/**
	 * Returns the value of the '<em><b>Description Box</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link gov.nasa.jpl.imce.oml.model.descriptions.DescriptionBox#getInstanceRelationshipUniversalRangeRestrictions <em>Instance Relationship Universal Range Restrictions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipUniversalRangeRestriction_DescriptionBox()
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionBox#getInstanceRelationshipUniversalRangeRestrictions
	 * @model opposite="instanceRelationshipUniversalRangeRestrictions" required="true" transient="false"
	 * @generated
	 */
	DescriptionBox getDescriptionBox();

	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getDescriptionBox <em>Description Box</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipUniversalRangeRestriction_Domain()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getDomain <em>Domain</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipUniversalRangeRestriction_RestrictedRelationship()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getRestrictedRelationship <em>Restricted Relationship</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRange(Entity)
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipUniversalRangeRestriction_Range()
	 * @model required="true"
	 * @generated
	 */
	Entity getRange();
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipUniversalRangeRestriction#getRange <em>Range</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * @model unique="false"
	 *        annotation="http://imce.jpl.nasa.gov/oml/Scala code='extent.descriptionBoxOfInstanceRelationshipUniversalRangeRestriction.get(this)'"
