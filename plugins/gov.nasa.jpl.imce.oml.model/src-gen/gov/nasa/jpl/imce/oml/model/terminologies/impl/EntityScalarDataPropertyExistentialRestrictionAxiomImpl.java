 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.EntityScalarDataPropertyExistentialRestrictionAxiomImpl#getScalarRestriction <em>Scalar Restriction</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityScalarDataPropertyExistentialRestrictionAxiomImpl extends EntityScalarDataPropertyRestrictionAxiomImpl implements EntityScalarDataPropertyExistentialRestrictionAxiom {
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.ENTITY_SCALAR_DATA_PROPERTY_EXISTENTIAL_RESTRICTION_AXIOM;
	}
	...
	public DataRange getScalarRestriction() {
		if (scalarRestriction != null && scalarRestriction.eIsProxy()) {
			...
			if (scalarRestriction != oldScalarRestriction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TerminologiesPackage.ENTITY_SCALAR_DATA_PROPERTY_EXISTENTIAL_RESTRICTION_AXIOM__SCALAR_RESTRICTION, oldScalarRestriction, scalarRestriction));
			}
		}
	...
	public void setScalarRestriction(DataRange newScalarRestriction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.ENTITY_SCALAR_DATA_PROPERTY_EXISTENTIAL_RESTRICTION_AXIOM__SCALAR_RESTRICTION, oldScalarRestriction, scalarRestriction));
	}
	...
	public String uuid() {
		...
		UUID _derivedUUID = OMLExtensions.derivedUUID(
			"EntityScalarDataPropertyExistentialRestrictionAxiom", _mappedTo, _mappedTo_1, _mappedTo_2, _mappedTo_3);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.ENTITY_SCALAR_DATA_PROPERTY_EXISTENTIAL_RESTRICTION_AXIOM__SCALAR_RESTRICTION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.ENTITY_SCALAR_DATA_PROPERTY_EXISTENTIAL_RESTRICTION_AXIOM___UUID:
				return uuid();
		}
