...
public class ExtentImpl extends MinimalEObjectImpl.Container implements Extent {
	 ...
	 * @ordered
	 */
	protected EList<gov.nasa.jpl.imce.oml.model.common.Module> modules;
	 ...
	 * @generated
	 */
	public EList<gov.nasa.jpl.imce.oml.model.common.Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentWithInverseEList<gov.nasa.jpl.imce.oml.model.common.Module>(gov.nasa.jpl.imce.oml.model.common.Module.class, this, CommonPackage.EXTENT__MODULES, CommonPackage.MODULE__EXTENT);
		}
		return modules;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CommonPackage.EXTENT__MODULES:
				getModules().clear();
				getModules().addAll((Collection<? extends gov.nasa.jpl.imce.oml.model.common.Module>)newValue);
				return;
		}
