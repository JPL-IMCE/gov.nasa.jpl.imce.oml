...
public class AnnotationPropertyImpl extends IntrinsicIdentityKindImpl implements AnnotationProperty {
	 ...
	 * @generated
	 */
	public gov.nasa.jpl.imce.oml.model.common.Module getModule() {
		if (eContainerFeatureID() != CommonPackage.ANNOTATION_PROPERTY__MODULE) return null;
		return (gov.nasa.jpl.imce.oml.model.common.Module)eContainer();
	}
	 ...
	 * @generated
	 */
	public gov.nasa.jpl.imce.oml.model.common.Module basicGetModule() {
		if (eContainerFeatureID() != CommonPackage.ANNOTATION_PROPERTY__MODULE) return null;
		return (gov.nasa.jpl.imce.oml.model.common.Module)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetModule(gov.nasa.jpl.imce.oml.model.common.Module newModule, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setModule(gov.nasa.jpl.imce.oml.model.common.Module newModule) {
		if (newModule != eInternalContainer() || (eContainerFeatureID() != CommonPackage.ANNOTATION_PROPERTY__MODULE && newModule != null)) {
			...
			if (newModule != null)
				msgs = ((InternalEObject)newModule).eInverseAdd(this, CommonPackage.MODULE__ANNOTATION_PROPERTIES, gov.nasa.jpl.imce.oml.model.common.Module.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommonPackage.ANNOTATION_PROPERTY__MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetModule((gov.nasa.jpl.imce.oml.model.common.Module)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case CommonPackage.ANNOTATION_PROPERTY__MODULE:
				return eInternalContainer().eInverseRemove(this, CommonPackage.MODULE__ANNOTATION_PROPERTIES, gov.nasa.jpl.imce.oml.model.common.Module.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CommonPackage.ANNOTATION_PROPERTY__MODULE:
				setModule((gov.nasa.jpl.imce.oml.model.common.Module)newValue);
				return;
			case CommonPackage.ANNOTATION_PROPERTY__IRI:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case CommonPackage.ANNOTATION_PROPERTY__MODULE:
				setModule((gov.nasa.jpl.imce.oml.model.common.Module)null);
				return;
			case CommonPackage.ANNOTATION_PROPERTY__IRI:
				setIri(IRI_EDEFAULT);
				return;
