...
import gov.nasa.jpl.imce.oml.model.terminologies.impl.TerminologyAxiomImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.bundles.impl.TerminologyBundleAxiomImpl#getBundle <em>Bundle</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TerminologyBundleAxiomImpl extends TerminologyAxiomImpl implements TerminologyBundleAxiom {
	...
	protected EClass eStaticClass() {
		return BundlesPackage.Literals.TERMINOLOGY_BUNDLE_AXIOM;
	}
	...
	public Bundle getBundle() {
		if (eContainerFeatureID() != BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE) return null;
	...
	public NotificationChain basicSetBundle(Bundle newBundle, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newBundle, BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE, msgs);
		return msgs;
	}
	...
	public void setBundle(Bundle newBundle) {
		if (newBundle != eInternalContainer() || (eContainerFeatureID() != BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE && newBundle != null)) {
			...
			if (newBundle != null)
				msgs = ((InternalEObject)newBundle).eInverseAdd(this, BundlesPackage.BUNDLE__BUNDLE_AXIOMS, Bundle.class, msgs);
			msgs = basicSetBundle(newBundle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE, newBundle, newBundle));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case BundlesPackage.TERMINOLOGY_BUNDLE_AXIOM__BUNDLE:
				return eInternalContainer().eInverseRemove(this, BundlesPackage.BUNDLE__BUNDLE_AXIOMS, Bundle.class, msgs);
		}
