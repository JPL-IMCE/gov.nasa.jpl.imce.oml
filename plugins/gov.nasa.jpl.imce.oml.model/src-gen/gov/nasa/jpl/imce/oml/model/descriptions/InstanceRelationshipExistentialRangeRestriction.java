...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Instance Relationship Existential Range Restriction</b></em>'.
 * <!-- end-user-doc -->
 *
 * <!-- begin-model-doc -->
 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getDescriptionBox <em>Description Box</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getDomain <em>Domain</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getRestrictedRelationship <em>Restricted Relationship</em>}</li>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getRange <em>Range</em>}</li>
 * </ul>
 *
 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipExistentialRangeRestriction()
 * @model
 * @generated
 */
public interface InstanceRelationshipExistentialRangeRestriction extends TerminologyInstanceAssertion, ElementCrossReferenceTuple {
	/**
	 * Returns the value of the '<em><b>Description Box</b></em>' container reference.
	 * It is bidirectional and its opposite is '{@link gov.nasa.jpl.imce.oml.model.descriptions.DescriptionBox#getInstanceRelationshipExistentialRangeRestrictions <em>Instance Relationship Existential Range Restrictions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipExistentialRangeRestriction_DescriptionBox()
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionBox#getInstanceRelationshipExistentialRangeRestrictions
	 * @model opposite="instanceRelationshipExistentialRangeRestrictions" required="true" transient="false"
	 * @generated
	 */
	DescriptionBox getDescriptionBox();

	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getDescriptionBox <em>Description Box</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipExistentialRangeRestriction_Domain()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getDomain <em>Domain</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipExistentialRangeRestriction_RestrictedRelationship()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getRestrictedRelationship <em>Restricted Relationship</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRange(Entity)
	 * @see gov.nasa.jpl.imce.oml.model.descriptions.DescriptionsPackage#getInstanceRelationshipExistentialRangeRestriction_Range()
	 * @model required="true"
	 * @generated
	 */
	Entity getRange();
	...
	/**
	 * Sets the value of the '{@link gov.nasa.jpl.imce.oml.model.descriptions.InstanceRelationshipExistentialRangeRestriction#getRange <em>Range</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-user-doc -->
	 * @model unique="false"
	 *        annotation="http://imce.jpl.nasa.gov/oml/Scala code='extent.descriptionBoxOfInstanceRelationshipExistentialRangeRestriction.get(this)'"
