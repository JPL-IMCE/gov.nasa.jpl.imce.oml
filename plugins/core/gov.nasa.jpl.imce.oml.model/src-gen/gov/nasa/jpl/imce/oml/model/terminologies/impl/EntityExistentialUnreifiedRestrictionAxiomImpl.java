...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entity Existential Unreified Restriction Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.EntityExistentialUnreifiedRestrictionAxiomImpl#getRestrictedUnreifiedRelationship <em>Restricted Unreified Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityExistentialUnreifiedRestrictionAxiomImpl extends EntityExistentialRestrictionAxiomImpl implements EntityExistentialUnreifiedRestrictionAxiom {
	/**
	 ...
	 * @generated
	 */
	protected EntityExistentialUnreifiedRestrictionAxiomImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM;
	}
		...
		if (restrictedUnreifiedRelationship != null && ((EObject)restrictedUnreifiedRelationship).eIsProxy()) {
			...
			if (restrictedUnreifiedRelationship != oldRestrictedUnreifiedRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP, oldRestrictedUnreifiedRelationship, restrictedUnreifiedRelationship));
			}
		}
	...
	public void setRestrictedUnreifiedRelationship(UnreifiedRelationship newRestrictedUnreifiedRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP, oldRestrictedUnreifiedRelationship, restrictedUnreifiedRelationship));
	}
	...
	public String uuid() {
		...
		UUID _derivedUUID = OMLExtensions.derivedUUID(
			"EntityExistentialUnreifiedRestrictionAxiom", _mappedTo, _mappedTo_1, _mappedTo_2, _mappedTo_3);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EntityUnreifiedRestrictionAxiom.class) {
			switch (derivedFeatureID) {
				case TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP: return TerminologiesPackage.ENTITY_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EntityUnreifiedRestrictionAxiom.class) {
			switch (baseFeatureID) {
				case TerminologiesPackage.ENTITY_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP: return TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM__RESTRICTED_UNREIFIED_RELATIONSHIP;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == CrossReferencabilityKind.class) {
			switch (baseOperationID) {
				case CommonPackage.CROSS_REFERENCABILITY_KIND___UUID: return TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM___UUID;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == EntityRestrictionAxiom.class) {
			switch (baseOperationID) {
				case TerminologiesPackage.ENTITY_RESTRICTION_AXIOM___RESTRICTED_RELATION: return TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == EntityUnreifiedRestrictionAxiom.class) {
			switch (baseOperationID) {
				case TerminologiesPackage.ENTITY_UNREIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION: return TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM___UUID:
				return uuid();
			case TerminologiesPackage.ENTITY_EXISTENTIAL_UNREIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION:
				return restrictedRelation();
		}
		return super.eInvoke(operationID, arguments);
	}

} //EntityExistentialUnreifiedRestrictionAxiomImpl
