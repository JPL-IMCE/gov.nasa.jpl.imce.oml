...
public class GraphsFactoryImpl extends EFactoryImpl implements GraphsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case GraphsPackage.TERMINOLOGY_GRAPH: return (EObject)createTerminologyGraph();
			case GraphsPackage.CONCEPT_DESIGNATION_TERMINOLOGY_AXIOM: return (EObject)createConceptDesignationTerminologyAxiom();
			case GraphsPackage.TERMINOLOGY_NESTING_AXIOM: return (EObject)createTerminologyNestingAxiom();
			default:
