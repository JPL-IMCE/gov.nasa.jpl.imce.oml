 ...
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.TermImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TermImpl extends TerminologyBoxStatementImpl implements Term {
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.TERM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.TERM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.TERM__NAME:
				return getName();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.TERM___IRI:
				return iri();
			case TerminologiesPackage.TERM___ABBREV_IRI:
				return abbrevIRI();
			case TerminologiesPackage.TERM___NAME:
				return name();
