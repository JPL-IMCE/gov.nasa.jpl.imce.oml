...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Entity Universal Forward Reified Restriction Axiom</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.EntityUniversalForwardReifiedRestrictionAxiomImpl#getForwardProperty <em>Forward Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityUniversalForwardReifiedRestrictionAxiomImpl extends EntityExistentialRestrictionAxiomImpl implements EntityUniversalForwardReifiedRestrictionAxiom {
	/**
	 ...
	 * @generated
	 */
	protected EntityUniversalForwardReifiedRestrictionAxiomImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM;
	}
		...
		if (forwardProperty != null && ((EObject)forwardProperty).eIsProxy()) {
			...
			if (forwardProperty != oldForwardProperty) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY, oldForwardProperty, forwardProperty));
			}
		}
	...
	public void setForwardProperty(ForwardProperty newForwardProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY, oldForwardProperty, forwardProperty));
	}
	...
	public String uuid() {
		...
		UUID _derivedUUID = OMLExtensions.derivedUUID(
			"EntityUniversalForwardReifiedRestrictionAxiom", _mappedTo, _mappedTo_1, _mappedTo_2, _mappedTo_3);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EntityForwardReifiedRestrictionAxiom.class) {
			switch (derivedFeatureID) {
				case TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY: return TerminologiesPackage.ENTITY_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == EntityForwardReifiedRestrictionAxiom.class) {
			switch (baseFeatureID) {
				case TerminologiesPackage.ENTITY_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY: return TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM__FORWARD_PROPERTY;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == CrossReferencabilityKind.class) {
			switch (baseOperationID) {
				case CommonPackage.CROSS_REFERENCABILITY_KIND___UUID: return TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM___UUID;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == EntityRestrictionAxiom.class) {
			switch (baseOperationID) {
				case TerminologiesPackage.ENTITY_RESTRICTION_AXIOM___RESTRICTED_RELATION: return TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == EntityReifiedRestrictionAxiom.class) {
		...
		if (baseClass == EntityForwardReifiedRestrictionAxiom.class) {
			switch (baseOperationID) {
				case TerminologiesPackage.ENTITY_FORWARD_REIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION: return TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION;
				default: return -1;
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM___UUID:
				return uuid();
			case TerminologiesPackage.ENTITY_UNIVERSAL_FORWARD_REIFIED_RESTRICTION_AXIOM___RESTRICTED_RELATION:
				return restrictedRelation();
		}
		return super.eInvoke(operationID, arguments);
	}

} //EntityUniversalForwardReifiedRestrictionAxiomImpl
