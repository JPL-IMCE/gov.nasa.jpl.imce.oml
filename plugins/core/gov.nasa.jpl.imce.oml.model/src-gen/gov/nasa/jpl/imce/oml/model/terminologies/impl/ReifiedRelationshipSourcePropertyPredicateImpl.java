...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Reified Relationship Source Property Predicate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.ReifiedRelationshipSourcePropertyPredicateImpl#getReifiedRelationship <em>Reified Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReifiedRelationshipSourcePropertyPredicateImpl extends BinarySegmentForwardPropertyPredicateImpl implements ReifiedRelationshipSourcePropertyPredicate {
	/**
	 ...
	 * @generated
	 */
	protected ReifiedRelationshipSourcePropertyPredicateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE;
	}
		...
		if (reifiedRelationship != null && ((EObject)reifiedRelationship).eIsProxy()) {
			...
			if (reifiedRelationship != oldReifiedRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TerminologiesPackage.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE__REIFIED_RELATIONSHIP, oldReifiedRelationship, reifiedRelationship));
			}
		}
	...
	public void setReifiedRelationship(ReifiedRelationship newReifiedRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE__REIFIED_RELATIONSHIP, oldReifiedRelationship, reifiedRelationship));
	}
	...
	public String uuid() {
		...
		UUID _derivedUUID = OMLExtensions.derivedUUID(
			"ReifiedRelationshipSourcePropertyPredicate", _mappedTo, _mappedTo_1);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE__REIFIED_RELATIONSHIP:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE___TERM_PREDICATE:
				return termPredicate();
			case TerminologiesPackage.REIFIED_RELATIONSHIP_SOURCE_PROPERTY_PREDICATE___UUID:
				return uuid();
		}
		return super.eInvoke(operationID, arguments);
	}

} //ReifiedRelationshipSourcePropertyPredicateImpl
