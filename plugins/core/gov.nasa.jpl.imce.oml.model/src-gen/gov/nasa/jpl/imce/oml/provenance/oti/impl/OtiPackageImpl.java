...
import gov.nasa.jpl.imce.oml.provenance.oti.OtiFactory;
 ...
 * @generated
 */
public class OtiPackageImpl extends EPackageImpl implements OtiPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OtiPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OtiPackageImpl() {
		super(eNS_URI, OtiFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link OtiPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OtiPackage init() {
		if (isInited) return (OtiPackage)EPackage.Registry.INSTANCE.getEPackage(OtiPackage.eNS_URI);

		// Obtain or create and register package
		OtiPackageImpl theOtiPackage = (OtiPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OtiPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OtiPackageImpl());
		...
		theOtiPackage.createPackageContents();

		// Initialize created meta-data
		theOtiPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOtiPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OtiPackage.eNS_URI, theOtiPackage);
		return theOtiPackage;
	}
	 ...
	 * @generated
	 */
	public OtiFactory getOtiFactory() {
		return (OtiFactory)getEFactoryInstance();
	}
