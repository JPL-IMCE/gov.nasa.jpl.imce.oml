 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see gov.nasa.jpl.imce.oml.provenance.oti.OtiFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/emf/2002/GenModel copyrightText='\nCopyright 2016 California Institute of Technology (\"Caltech\").\nU.S. Government sponsorship acknowledged.\n\nLicensed under the Apache License, Version 2.0 (the \"License\");\nyou may not use this file except in compliance with the License.\nYou may obtain a copy of the License at\n\n     http://www.apache.org/licenses/LICENSE-2.0\n\nUnless required by applicable law or agreed to in writing, software\ndistributed under the License is distributed on an \"AS IS\" BASIS,\nWITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\nSee the License for the specific language governing permissions and\nlimitations under the License.\n' bundleManifest='false' childCreationExtenders='true' complianceLevel='8.0' featureDelegation='None' modelPluginVariables='org.eclipse.xtext.xbase.lib org.eclipse.emf.ecore.xcore.lib org.eclipse.emf.cdo' rootExtendsClass='org.eclipse.emf.internal.cdo.CDOObjectImpl' rootExtendsInterface='org.eclipse.emf.cdo.CDOObject' modelDirectory='gov.nasa.jpl.imce.oml.model/src-gen/' modelName='OML2OTI' basePackage='gov.nasa.jpl.imce.oml.provenance'"
 * @generated
 */
public interface OtiPackage extends EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	OtiPackage eINSTANCE = gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl.init();
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getOML2OTIProvenance()
	 * @generated
	 */
	 ...
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getUUID()
	 * @generated
	 */
	int UUID = 1;
	 ...
	 * <!-- end-user-doc -->
	 * @see java.lang.String
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getOML_IRI()
	 * @generated
	 */
	int OML_IRI = 2;
	 ...
	 * <!-- end-user-doc -->
	 * @see java.lang.String
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getOTI_TOOL_SPECIFIC_ID()
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see java.lang.String
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getOTI_TOOL_SPECIFIC_UUID()
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * @see java.lang.String
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.impl.OtiPackageImpl#getOTI_TOOL_SPECIFIC_URL()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link gov.nasa.jpl.imce.oml.provenance.oti.OML2OTIProvenance#getOmlIRI <em>Oml IRI</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Oml IRI</em>'.
	 * @see gov.nasa.jpl.imce.oml.provenance.oti.OML2OTIProvenance#getOmlIRI()
	 * @see #getOML2OTIProvenance()
	 * @generated
	 */
