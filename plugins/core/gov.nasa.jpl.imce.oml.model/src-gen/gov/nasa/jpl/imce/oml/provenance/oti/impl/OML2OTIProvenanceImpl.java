...
import gov.nasa.jpl.imce.oml.provenance.oti.OtiPackage;
 ...
 *   <li>{@link gov.nasa.jpl.imce.oml.provenance.oti.impl.OML2OTIProvenanceImpl#getOmlIRI <em>Oml IRI</em>}</li>
 ...
 * @generated
 */
public class OML2OTIProvenanceImpl extends CDOObjectImpl implements OML2OTIProvenance {
	/**
	...
	protected EClass eStaticClass() {
		return OtiPackage.Literals.OML2OTI_PROVENANCE;
	}
	...
	public void setOmlUUID(String newOmlUUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__OML_UUID, oldOmlUUID, omlUUID));
	}
	...
	public void setOmlIRI(String newOmlIRI) {
		...
		omlIRI = newOmlIRI;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__OML_IRI, oldOmlIRI, omlIRI));
	}
	...
	public void setOtiID(String newOtiID) {
		...
		otiID = newOtiID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__OTI_ID, oldOtiID, otiID));
	}
	...
	public void setOtiURL(String newOtiURL) {
		...
		otiURL = newOtiURL;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__OTI_URL, oldOtiURL, otiURL));
	}
	...
	public void setOtiUUID(String newOtiUUID) {
		...
		otiUUID = newOtiUUID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__OTI_UUID, oldOtiUUID, otiUUID));
	}
	...
	public void setExplanation(String newExplanation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OtiPackage.OML2OTI_PROVENANCE__EXPLANATION, oldExplanation, explanation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OtiPackage.OML2OTI_PROVENANCE__OML_UUID:
				return getOmlUUID();
			case OtiPackage.OML2OTI_PROVENANCE__OML_IRI:
				return getOmlIRI();
			case OtiPackage.OML2OTI_PROVENANCE__OTI_ID:
				return getOtiID();
			case OtiPackage.OML2OTI_PROVENANCE__OTI_URL:
				return getOtiURL();
			case OtiPackage.OML2OTI_PROVENANCE__OTI_UUID:
				return getOtiUUID();
			case OtiPackage.OML2OTI_PROVENANCE__EXPLANATION:
