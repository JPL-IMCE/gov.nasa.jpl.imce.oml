...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unreified Relationship Property Predicate</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link gov.nasa.jpl.imce.oml.model.terminologies.impl.UnreifiedRelationshipPropertyPredicateImpl#getUnreifiedRelationship <em>Unreified Relationship</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnreifiedRelationshipPropertyPredicateImpl extends BinarySegmentForwardPropertyPredicateImpl implements UnreifiedRelationshipPropertyPredicate {
	/**
	 ...
	 * @generated
	 */
	protected UnreifiedRelationshipPropertyPredicateImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TerminologiesPackage.Literals.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE;
	}
		...
		if (unreifiedRelationship != null && ((EObject)unreifiedRelationship).eIsProxy()) {
			...
			if (unreifiedRelationship != oldUnreifiedRelationship) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TerminologiesPackage.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE__UNREIFIED_RELATIONSHIP, oldUnreifiedRelationship, unreifiedRelationship));
			}
		}
	...
	public void setUnreifiedRelationship(UnreifiedRelationship newUnreifiedRelationship) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TerminologiesPackage.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE__UNREIFIED_RELATIONSHIP, oldUnreifiedRelationship, unreifiedRelationship));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TerminologiesPackage.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE__UNREIFIED_RELATIONSHIP:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TerminologiesPackage.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE___TERM_PREDICATE:
				return termPredicate();
			case TerminologiesPackage.UNREIFIED_RELATIONSHIP_PROPERTY_PREDICATE___UUID:
				return uuid();
		}
		return super.eInvoke(operationID, arguments);
	}

} //UnreifiedRelationshipPropertyPredicateImpl
