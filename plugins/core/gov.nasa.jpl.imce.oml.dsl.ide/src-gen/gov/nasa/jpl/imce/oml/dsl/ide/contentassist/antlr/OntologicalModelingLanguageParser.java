...
import gov.nasa.jpl.imce.oml.dsl.ide.contentassist.antlr.internal.InternalOntologicalModelingLanguageParser;
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTerminologyGraphAccess().getBoxAxiomsAssignment_4_1(), "rule__TerminologyGraph__BoxAxiomsAssignment_4_1");
					...
					put(grammarAccess.getBundleAccess().getBoxAxiomsAssignment_4_1(), "rule__Bundle__BoxAxiomsAssignment_4_1");
					...
					put(grammarAccess.getBundleAccess().getBundleAxiomsAssignment_4_4(), "rule__Bundle__BundleAxiomsAssignment_4_4");
					...
					put(grammarAccess.getDescriptionBoxAccess().getSingletonScalarDataPropertyValuesAssignment_4_8(), "rule__DescriptionBox__SingletonScalarDataPropertyValuesAssignment_4_8");
					put(grammarAccess.getDescriptionBoxAccess().getSingletonStructuredDataPropertyValuesAssignment_4_9(), "rule__DescriptionBox__SingletonStructuredDataPropertyValuesAssignment_4_9");
