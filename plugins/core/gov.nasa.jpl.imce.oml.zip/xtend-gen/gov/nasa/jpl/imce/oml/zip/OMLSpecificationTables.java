...
public class OMLSpecificationTables {
  ...
  public OMLSpecificationTables() {
    ...
    HashMap<String, Pair<AnnotationProperty, Map<String, String>>> _hashMap = new HashMap<String, Pair<AnnotationProperty, Map<String, String>>>();
    this.annotationProperties = _hashMap;
    ...
    HashMap<String, Pair<ConceptDesignationTerminologyAxiom, Map<String, String>>> _hashMap_3 = new HashMap<String, Pair<ConceptDesignationTerminologyAxiom, Map<String, String>>>();
    this.conceptDesignationTerminologyAxioms = _hashMap_3;
    HashMap<String, Pair<TerminologyExtensionAxiom, Map<String, String>>> _hashMap_4 = new HashMap<String, Pair<TerminologyExtensionAxiom, Map<String, String>>>();
    this.terminologyExtensionAxioms = _hashMap_4;
    HashMap<String, Pair<TerminologyNestingAxiom, Map<String, String>>> _hashMap_5 = new HashMap<String, Pair<TerminologyNestingAxiom, Map<String, String>>>();
    this.terminologyNestingAxioms = _hashMap_5;
    HashMap<String, Pair<Aspect, Map<String, String>>> _hashMap_6 = new HashMap<String, Pair<Aspect, Map<String, String>>>();
    this.aspects = _hashMap_6;
    HashMap<String, Pair<Concept, Map<String, String>>> _hashMap_7 = new HashMap<String, Pair<Concept, Map<String, String>>>();
    this.concepts = _hashMap_7;
    HashMap<String, Pair<ReifiedRelationship, Map<String, String>>> _hashMap_8 = new HashMap<String, Pair<ReifiedRelationship, Map<String, String>>>();
    this.reifiedRelationships = _hashMap_8;
    HashMap<String, Pair<UnreifiedRelationship, Map<String, String>>> _hashMap_9 = new HashMap<String, Pair<UnreifiedRelationship, Map<String, String>>>();
    this.unreifiedRelationships = _hashMap_9;
    HashMap<String, Pair<Scalar, Map<String, String>>> _hashMap_10 = new HashMap<String, Pair<Scalar, Map<String, String>>>();
    this.scalars = _hashMap_10;
    HashMap<String, Pair<Structure, Map<String, String>>> _hashMap_11 = new HashMap<String, Pair<Structure, Map<String, String>>>();
    this.structures = _hashMap_11;
    HashMap<String, Pair<BinaryScalarRestriction, Map<String, String>>> _hashMap_12 = new HashMap<String, Pair<BinaryScalarRestriction, Map<String, String>>>();
    this.binaryScalarRestrictions = _hashMap_12;
    HashMap<String, Pair<IRIScalarRestriction, Map<String, String>>> _hashMap_13 = new HashMap<String, Pair<IRIScalarRestriction, Map<String, String>>>();
    this.iriScalarRestrictions = _hashMap_13;
    HashMap<String, Pair<NumericScalarRestriction, Map<String, String>>> _hashMap_14 = new HashMap<String, Pair<NumericScalarRestriction, Map<String, String>>>();
    this.numericScalarRestrictions = _hashMap_14;
    HashMap<String, Pair<PlainLiteralScalarRestriction, Map<String, String>>> _hashMap_15 = new HashMap<String, Pair<PlainLiteralScalarRestriction, Map<String, String>>>();
    this.plainLiteralScalarRestrictions = _hashMap_15;
    HashMap<String, Pair<ScalarOneOfRestriction, Map<String, String>>> _hashMap_16 = new HashMap<String, Pair<ScalarOneOfRestriction, Map<String, String>>>();
    this.scalarOneOfRestrictions = _hashMap_16;
    HashMap<String, Pair<StringScalarRestriction, Map<String, String>>> _hashMap_17 = new HashMap<String, Pair<StringScalarRestriction, Map<String, String>>>();
    this.stringScalarRestrictions = _hashMap_17;
    HashMap<String, Pair<SynonymScalarRestriction, Map<String, String>>> _hashMap_18 = new HashMap<String, Pair<SynonymScalarRestriction, Map<String, String>>>();
    this.synonymScalarRestrictions = _hashMap_18;
    HashMap<String, Pair<TimeScalarRestriction, Map<String, String>>> _hashMap_19 = new HashMap<String, Pair<TimeScalarRestriction, Map<String, String>>>();
    this.timeScalarRestrictions = _hashMap_19;
    HashMap<String, Pair<EntityScalarDataProperty, Map<String, String>>> _hashMap_20 = new HashMap<String, Pair<EntityScalarDataProperty, Map<String, String>>>();
    this.entityScalarDataProperties = _hashMap_20;
    HashMap<String, Pair<EntityStructuredDataProperty, Map<String, String>>> _hashMap_21 = new HashMap<String, Pair<EntityStructuredDataProperty, Map<String, String>>>();
    this.entityStructuredDataProperties = _hashMap_21;
    HashMap<String, Pair<ScalarDataProperty, Map<String, String>>> _hashMap_22 = new HashMap<String, Pair<ScalarDataProperty, Map<String, String>>>();
    this.scalarDataProperties = _hashMap_22;
    HashMap<String, Pair<StructuredDataProperty, Map<String, String>>> _hashMap_23 = new HashMap<String, Pair<StructuredDataProperty, Map<String, String>>>();
    this.structuredDataProperties = _hashMap_23;
    HashMap<String, Pair<AspectSpecializationAxiom, Map<String, String>>> _hashMap_24 = new HashMap<String, Pair<AspectSpecializationAxiom, Map<String, String>>>();
    this.aspectSpecializationAxioms = _hashMap_24;
    HashMap<String, Pair<ConceptSpecializationAxiom, Map<String, String>>> _hashMap_25 = new HashMap<String, Pair<ConceptSpecializationAxiom, Map<String, String>>>();
    this.conceptSpecializationAxioms = _hashMap_25;
    HashMap<String, Pair<ReifiedRelationshipSpecializationAxiom, Map<String, String>>> _hashMap_26 = new HashMap<String, Pair<ReifiedRelationshipSpecializationAxiom, Map<String, String>>>();
    this.reifiedRelationshipSpecializationAxioms = _hashMap_26;
    HashMap<String, Pair<EntityExistentialRestrictionAxiom, Map<String, String>>> _hashMap_27 = new HashMap<String, Pair<EntityExistentialRestrictionAxiom, Map<String, String>>>();
    this.entityExistentialRestrictionAxioms = _hashMap_27;
    HashMap<String, Pair<EntityUniversalRestrictionAxiom, Map<String, String>>> _hashMap_28 = new HashMap<String, Pair<EntityUniversalRestrictionAxiom, Map<String, String>>>();
    this.entityUniversalRestrictionAxioms = _hashMap_28;
    HashMap<String, Pair<EntityScalarDataPropertyExistentialRestrictionAxiom, Map<String, String>>> _hashMap_29 = new HashMap<String, Pair<EntityScalarDataPropertyExistentialRestrictionAxiom, Map<String, String>>>();
    this.entityScalarDataPropertyExistentialRestrictionAxioms = _hashMap_29;
    HashMap<String, Pair<EntityScalarDataPropertyParticularRestrictionAxiom, Map<String, String>>> _hashMap_30 = new HashMap<String, Pair<EntityScalarDataPropertyParticularRestrictionAxiom, Map<String, String>>>();
    this.entityScalarDataPropertyParticularRestrictionAxioms = _hashMap_30;
    HashMap<String, Pair<EntityScalarDataPropertyUniversalRestrictionAxiom, Map<String, String>>> _hashMap_31 = new HashMap<String, Pair<EntityScalarDataPropertyUniversalRestrictionAxiom, Map<String, String>>>();
    this.entityScalarDataPropertyUniversalRestrictionAxioms = _hashMap_31;
    HashMap<String, Pair<ScalarOneOfLiteralAxiom, Map<String, String>>> _hashMap_32 = new HashMap<String, Pair<ScalarOneOfLiteralAxiom, Map<String, String>>>();
    this.scalarOneOfLiteralAxioms = _hashMap_32;
    HashMap<String, Pair<BundledTerminologyAxiom, Map<String, String>>> _hashMap_33 = new HashMap<String, Pair<BundledTerminologyAxiom, Map<String, String>>>();
    this.bundledTerminologyAxioms = _hashMap_33;
    HashMap<String, Pair<RootConceptTaxonomyAxiom, Map<String, String>>> _hashMap_34 = new HashMap<String, Pair<RootConceptTaxonomyAxiom, Map<String, String>>>();
    this.rootConceptTaxonomyAxioms = _hashMap_34;
    HashMap<String, Pair<SpecificDisjointConceptAxiom, Map<String, String>>> _hashMap_35 = new HashMap<String, Pair<SpecificDisjointConceptAxiom, Map<String, String>>>();
    this.specificDisjointConceptAxioms = _hashMap_35;
    HashMap<String, Pair<AnnotationPropertyValue, Map<String, String>>> _hashMap_36 = new HashMap<String, Pair<AnnotationPropertyValue, Map<String, String>>>();
    this.annotationPropertyValues = _hashMap_36;
    HashMap<String, Pair<AnonymousConceptUnionAxiom, Map<String, String>>> _hashMap_37 = new HashMap<String, Pair<AnonymousConceptUnionAxiom, Map<String, String>>>();
    this.anonymousConceptUnionAxioms = _hashMap_37;
    HashMap<String, Pair<AspectPredicate, Map<String, String>>> _hashMap_38 = new HashMap<String, Pair<AspectPredicate, Map<String, String>>>();
    this.aspectPredicates = _hashMap_38;
    HashMap<String, Pair<ChainRule, Map<String, String>>> _hashMap_39 = new HashMap<String, Pair<ChainRule, Map<String, String>>>();
    this.chainRules = _hashMap_39;
    HashMap<String, Pair<ConceptInstance, Map<String, String>>> _hashMap_40 = new HashMap<String, Pair<ConceptInstance, Map<String, String>>>();
    this.conceptInstances = _hashMap_40;
    HashMap<String, Pair<ConceptPredicate, Map<String, String>>> _hashMap_41 = new HashMap<String, Pair<ConceptPredicate, Map<String, String>>>();
    this.conceptPredicates = _hashMap_41;
    HashMap<String, Pair<DescriptionBox, Map<String, String>>> _hashMap_42 = new HashMap<String, Pair<DescriptionBox, Map<String, String>>>();
    this.descriptionBoxes = _hashMap_42;
    HashMap<String, Pair<DescriptionBoxExtendsClosedWorldDefinitions, Map<String, String>>> _hashMap_43 = new HashMap<String, Pair<DescriptionBoxExtendsClosedWorldDefinitions, Map<String, String>>>();
    this.descriptionBoxExtendsClosedWorldDefinitions = _hashMap_43;
    HashMap<String, Pair<DescriptionBoxRefinement, Map<String, String>>> _hashMap_44 = new HashMap<String, Pair<DescriptionBoxRefinement, Map<String, String>>>();
    this.descriptionBoxRefinements = _hashMap_44;
    HashMap<String, Pair<EntityStructuredDataPropertyParticularRestrictionAxiom, Map<String, String>>> _hashMap_45 = new HashMap<String, Pair<EntityStructuredDataPropertyParticularRestrictionAxiom, Map<String, String>>>();
    this.entityStructuredDataPropertyParticularRestrictionAxioms = _hashMap_45;
    HashMap<String, Pair<ReifiedRelationshipInstance, Map<String, String>>> _hashMap_46 = new HashMap<String, Pair<ReifiedRelationshipInstance, Map<String, String>>>();
    this.reifiedRelationshipInstances = _hashMap_46;
    HashMap<String, Pair<ReifiedRelationshipInstanceDomain, Map<String, String>>> _hashMap_47 = new HashMap<String, Pair<ReifiedRelationshipInstanceDomain, Map<String, String>>>();
    this.reifiedRelationshipInstanceDomains = _hashMap_47;
    HashMap<String, Pair<ReifiedRelationshipInstanceRange, Map<String, String>>> _hashMap_48 = new HashMap<String, Pair<ReifiedRelationshipInstanceRange, Map<String, String>>>();
    this.reifiedRelationshipInstanceRanges = _hashMap_48;
    HashMap<String, Pair<ReifiedRelationshipInversePropertyPredicate, Map<String, String>>> _hashMap_49 = new HashMap<String, Pair<ReifiedRelationshipInversePropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipInversePropertyPredicates = _hashMap_49;
    HashMap<String, Pair<ReifiedRelationshipPredicate, Map<String, String>>> _hashMap_50 = new HashMap<String, Pair<ReifiedRelationshipPredicate, Map<String, String>>>();
    this.reifiedRelationshipPredicates = _hashMap_50;
    HashMap<String, Pair<ReifiedRelationshipPropertyPredicate, Map<String, String>>> _hashMap_51 = new HashMap<String, Pair<ReifiedRelationshipPropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipPropertyPredicates = _hashMap_51;
    HashMap<String, Pair<ReifiedRelationshipSourceInversePropertyPredicate, Map<String, String>>> _hashMap_52 = new HashMap<String, Pair<ReifiedRelationshipSourceInversePropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipSourceInversePropertyPredicates = _hashMap_52;
    HashMap<String, Pair<ReifiedRelationshipSourcePropertyPredicate, Map<String, String>>> _hashMap_53 = new HashMap<String, Pair<ReifiedRelationshipSourcePropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipSourcePropertyPredicates = _hashMap_53;
    HashMap<String, Pair<ReifiedRelationshipTargetInversePropertyPredicate, Map<String, String>>> _hashMap_54 = new HashMap<String, Pair<ReifiedRelationshipTargetInversePropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipTargetInversePropertyPredicates = _hashMap_54;
    HashMap<String, Pair<ReifiedRelationshipTargetPropertyPredicate, Map<String, String>>> _hashMap_55 = new HashMap<String, Pair<ReifiedRelationshipTargetPropertyPredicate, Map<String, String>>>();
    this.reifiedRelationshipTargetPropertyPredicates = _hashMap_55;
    HashMap<String, Pair<RestrictionScalarDataPropertyValue, Map<String, String>>> _hashMap_56 = new HashMap<String, Pair<RestrictionScalarDataPropertyValue, Map<String, String>>>();
    this.restrictionScalarDataPropertyValues = _hashMap_56;
    HashMap<String, Pair<RestrictionStructuredDataPropertyTuple, Map<String, String>>> _hashMap_57 = new HashMap<String, Pair<RestrictionStructuredDataPropertyTuple, Map<String, String>>>();
    this.restrictionStructuredDataPropertyTuples = _hashMap_57;
    HashMap<String, Pair<RuleBodySegment, Map<String, String>>> _hashMap_58 = new HashMap<String, Pair<RuleBodySegment, Map<String, String>>>();
    this.ruleBodySegments = _hashMap_58;
    ...
    HashMap<String, Pair<SingletonInstanceScalarDataPropertyValue, Map<String, String>>> _hashMap_60 = new HashMap<String, Pair<SingletonInstanceScalarDataPropertyValue, Map<String, String>>>();
    this.singletonInstanceScalarDataPropertyValues = _hashMap_60;
    HashMap<String, Pair<SingletonInstanceStructuredDataPropertyValue, Map<String, String>>> _hashMap_61 = new HashMap<String, Pair<SingletonInstanceStructuredDataPropertyValue, Map<String, String>>>();
