...
class OMLSpecificationTables {
  ...
  static def byte[] terminologyGraphsByteArray(Extent e) {
      ...
      pw.print(",")
      pw.print("\"kind\":")
      pw.print(OMLTables.toPlainString(it.kind))
      pw.print(",")
      pw.print("\"iri\":")
  ...
  static def byte[] annotationPropertiesByteArray(Extent e) {
      ...
      pw.print(",")
      pw.print("\"abbrevIRI\":")
      pw.print(OMLTables.toPlainString(it.abbrevIRI))
      pw.println("}")
    ]
    pw.close()
    return bos.toByteArray()
  ...
  static def byte[] binaryScalarRestrictionsByteArray(Extent e) {
      ...
      pw.print(",")
      pw.print("\"length\":")
      pw.print(OMLTables.toPlainString(it.length))
      pw.print(",")
      pw.print("\"minLength\":")
      pw.print(OMLTables.toPlainString(it.minLength))
      pw.print(",")
      pw.print("\"maxLength\":")
      pw.print(OMLTables.toPlainString(it.maxLength))
      pw.print(",")
      pw.print("\"name\":")
      pw.print(OMLTables.toPlainString(it.name()))
      pw.println("}")
  ...
  static def byte[] numericScalarRestrictionsByteArray(Extent e) {
      ...
      pw.print(OMLTables.toPlainString(it.minExclusive))
      pw.print(",")
      pw.print("\"minInclusive\":")
      pw.print(OMLTables.toPlainString(it.minInclusive))
      pw.print(",")
      pw.print("\"maxExclusive\":")
      pw.print(OMLTables.toPlainString(it.maxExclusive))
      pw.print(",")
      pw.print("\"maxInclusive\":")
      pw.print(OMLTables.toPlainString(it.maxInclusive))
      pw.print(",")
      pw.print("\"name\":")
      pw.print(OMLTables.toPlainString(it.name()))
      pw.println("}")
  ...
  static def byte[] plainLiteralScalarRestrictionsByteArray(Extent e) {
      ...
      pw.print(",")
      pw.print("\"langRange\":")
      pw.print(OMLTables.toPlainString(it.langRange))
      pw.print(",")
      pw.print("\"pattern\":")
  ...
  static def byte[] scalarOneOfLiteralAxiomsByteArray(Extent e) {
      ...
      pw.print(",")
      pw.print("\"value\":")
      pw.print(OMLTables.toStringArray(it.value))
      pw.print(",")
  ...
  static def byte[] entityScalarDataPropertiesByteArray(Extent e) {
      ...
      pw.print(OMLTables.toPlainString(it.isIdentityCriteria))
      pw.print(",")
      pw.print("\"name\":")
      pw.print(OMLTables.toPlainString(it.name()))
      pw.println("}")
  ...
  static def byte[] reifiedRelationshipsByteArray(Extent e) {
      ...
      pw.print(OMLTables.toPlainString(it.isAsymmetric))
      pw.print(",")
      pw.print("\"isEssential\":")
      pw.print(OMLTables.toPlainString(it.isEssential))
      pw.print(",")
      pw.print("\"isFunctional\":")
      pw.print(OMLTables.toPlainString(it.isFunctional))
      pw.print(",")
      pw.print("\"isInverseEssential\":")
      pw.print(OMLTables.toPlainString(it.isInverseEssential))
      pw.print(",")
      pw.print("\"isInverseFunctional\":")
      pw.print(OMLTables.toPlainString(it.isInverseFunctional))
      pw.print(",")
      pw.print("\"isIrreflexive\":")
      pw.print(OMLTables.toPlainString(it.isIrreflexive))
      pw.print(",")
      pw.print("\"isReflexive\":")
      pw.print(OMLTables.toPlainString(it.isReflexive))
      pw.print(",")
      pw.print("\"isSymmetric\":")
      pw.print(OMLTables.toPlainString(it.isSymmetric))
      pw.print(",")
      pw.print("\"isTransitive\":")
      pw.print(OMLTables.toPlainString(it.isTransitive))
      pw.print(",")
      pw.print("\"name\":")
      pw.print(OMLTables.toPlainString(it.name()))
      pw.print(",")
      pw.print("\"unreifiedPropertyName\":")
      pw.print(OMLTables.toPlainString(it.unreifiedPropertyName))
      pw.print(",")
      pw.print("\"unreifiedInversePropertyName\":")
      pw.print(OMLTables.toPlainString(it.unreifiedInversePropertyName))
      pw.println("}")
    ]
    pw.close()
    return bos.toByteArray()
  ...
  static def byte[] entityScalarDataPropertyParticularRestrictionAxiomsByteArray(Extent e) {
      ...
      pw.print(OMLTables.toStringArray(it.literalValue))
      pw.print(",")
      pw.print("\"valueTypeUUID\":")
      if (null !== valueType) {
        pw.print("\"")
  ...
  static def byte[] restrictionScalarDataPropertyValuesByteArray(Extent e) {
      ...
      pw.print(OMLTables.toStringArray(it.scalarPropertyValue))
      pw.print(",")
      pw.print("\"structuredDataPropertyContextUUID\":")
      pw.print("\"")
      pw.print(it.structuredDataPropertyContext.uuid())
