...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.terminologies.RestrictionScalarDataPropertyValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RestrictionScalarDataPropertyValueItemProvider extends ElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RestrictionScalarDataPropertyValueItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RestrictionScalarDataPropertyValue_structuredDataPropertyContext_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RestrictionScalarDataPropertyValue_structuredDataPropertyContext_feature", "_UI_RestrictionScalarDataPropertyValue_type"),
				 TerminologiesPackage.Literals.RESTRICTION_SCALAR_DATA_PROPERTY_VALUE__STRUCTURED_DATA_PROPERTY_CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addScalarPropertyValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RestrictionScalarDataPropertyValue_scalarPropertyValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RestrictionScalarDataPropertyValue_scalarPropertyValue_feature", "_UI_RestrictionScalarDataPropertyValue_type"),
	...
	/**
	 * This returns RestrictionScalarDataPropertyValue.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RestrictionScalarDataPropertyValue"));
	}
	...
	public String getText(Object object) {
		String label = ((RestrictionScalarDataPropertyValue)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_RestrictionScalarDataPropertyValue_type") :
			getString("_UI_RestrictionScalarDataPropertyValue_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RestrictionScalarDataPropertyValue.class)) {
