...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.bundles.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BundleItemProvider extends TerminologyBoxItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BundlesPackage.Literals.BUNDLE__BUNDLE_AXIOMS);
			childrenFeatures.add(BundlesPackage.Literals.BUNDLE__BUNDLE_STATEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BundlesPackage.Literals.BUNDLE__BUNDLE_AXIOMS,
				 BundlesFactory.eINSTANCE.createBundledTerminologyAxiom()));

		newChildDescriptors.add
			(createChildParameter
				(BundlesPackage.Literals.BUNDLE__BUNDLE_STATEMENTS,
				 BundlesFactory.eINSTANCE.createRootConceptTaxonomyAxiom()));
	}
