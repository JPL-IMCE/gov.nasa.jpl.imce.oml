...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.terminologies.RestrictionStructuredDataPropertyContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RestrictionStructuredDataPropertyContextItemProvider extends ElementItemProvider {
	 ...
	 * @generated
	 */
	public RestrictionStructuredDataPropertyContextItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RestrictionStructuredDataPropertyContext)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_RestrictionStructuredDataPropertyContext_type") :
			getString("_UI_RestrictionStructuredDataPropertyContext_type") + " " + label;
	}
