...
/**
 * This is the item provider adapter for a {@link gov.nasa.jpl.imce.oml.model.terminologies.EntityUnreifiedRestrictionAxiom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityUnreifiedRestrictionAxiomItemProvider extends EntityRestrictionAxiomItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EntityUnreifiedRestrictionAxiomItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((EntityUnreifiedRestrictionAxiom)object).getUuid();
		return label == null || label.length() == 0 ?
			getString("_UI_EntityUnreifiedRestrictionAxiom_type") :
			getString("_UI_EntityUnreifiedRestrictionAxiom_type") + " " + label;
	}
