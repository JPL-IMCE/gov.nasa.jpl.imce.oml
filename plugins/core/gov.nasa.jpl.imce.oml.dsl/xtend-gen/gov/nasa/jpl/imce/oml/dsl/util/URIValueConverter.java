...
public class URIValueConverter extends GenericValueConverter<URIValue> {
  @Inject
  protected IValueConverterService valueConverterService;
  
  @Override
  public String toEscapedString(final URIValue value) {
    return value.value;
  }
  
  @Override
  public URIValue toValue(final String string, final INode node) throws ValueConverterException {
