...
public class OntologicalModelingLanguageCrossReferenceSerializer extends CrossReferenceSerializer {
  @Inject
  ...
  public String serializeCrossRef(final EObject semanticObject, final CrossReference crossref, final EObject target, final INode node, final ISerializationDiagnostic.Acceptor errors) {
    String _xblockexpression = null;
    {
      ...
      if (_equals) {
        ...
        if (target instanceof TerminologyBox) {
          _matched=true;
          String _iri = ((TerminologyBox)target).iri();
          String _plus = ("<" + _iri);
          _switchResult = (_plus + ">");
        }
        if (!_matched) {
          ...
          String _plus = ("OntologicalModelingLanguageCrossReferenceSerializer.serializeCrossRef(..., \'ExternalReference\', target, ...): target must be a TerminologyBox, not: " + _xifexpression_1);
