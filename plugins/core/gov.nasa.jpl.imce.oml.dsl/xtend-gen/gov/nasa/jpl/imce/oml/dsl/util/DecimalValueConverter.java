...
public class DecimalValueConverter extends GenericValueConverter<DecimalValue> {
  @Inject
  protected IValueConverterService valueConverterService;
  
  @Override
  public String toEscapedString(final DecimalValue value) {
    return value.value;
  }
  
  @Override
  public DecimalValue toValue(final String string, final INode node) throws ValueConverterException {
