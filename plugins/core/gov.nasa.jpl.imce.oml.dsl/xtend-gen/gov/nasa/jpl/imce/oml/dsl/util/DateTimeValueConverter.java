...
public class DateTimeValueConverter extends GenericValueConverter<DateTimeValue> {
  @Inject
  protected IValueConverterService valueConverterService;
  
  @Override
  public String toEscapedString(final DateTimeValue value) {
    return value.value;
  }
  
  @Override
  public DateTimeValue toValue(final String string, final INode node) throws ValueConverterException {
