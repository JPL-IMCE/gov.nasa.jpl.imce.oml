		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTerminologyGraphAccess().getAlternatives_6(), "rule__TerminologyGraph__Alternatives_6");
					put(grammarAccess.getBundleAccess().getAlternatives_6(), "rule__Bundle__Alternatives_6");
					put(grammarAccess.getDescriptionBoxAccess().getAlternatives_6(), "rule__DescriptionBox__Alternatives_6");
					...
					put(grammarAccess.getEntityExistentialForwardReifiedRestrictionAxiomAccess().getGroup(), "rule__EntityExistentialForwardReifiedRestrictionAxiom__Group__0");
					put(grammarAccess.getEntityExistentialInverseReifiedRestrictionAxiomAccess().getGroup(), "rule__EntityExistentialInverseReifiedRestrictionAxiom__Group__0");
					put(grammarAccess.getEntityExistentialUnreifiedRestrictionAxiomAccess().getGroup(), "rule__EntityExistentialUnreifiedRestrictionAxiom__Group__0");
					put(grammarAccess.getEntityUniversalForwardReifiedRestrictionAxiomAccess().getGroup(), "rule__EntityUniversalForwardReifiedRestrictionAxiom__Group__0");
					put(grammarAccess.getEntityUniversalInverseReifiedRestrictionAxiomAccess().getGroup(), "rule__EntityUniversalInverseReifiedRestrictionAxiom__Group__0");
					put(grammarAccess.getEntityUniversalUnreifiedRestrictionAxiomAccess().getGroup(), "rule__EntityUniversalUnreifiedRestrictionAxiom__Group__0");
					...
					put(grammarAccess.getExtentAccess().getModulesAssignment_1(), "rule__Extent__ModulesAssignment_1");
					...
					put(grammarAccess.getTerminologyGraphAccess().getAnnotationPropertiesAssignment_0(), "rule__TerminologyGraph__AnnotationPropertiesAssignment_0");
					put(grammarAccess.getTerminologyGraphAccess().getAnnotationsAssignment_1(), "rule__TerminologyGraph__AnnotationsAssignment_1");
					put(grammarAccess.getTerminologyGraphAccess().getKindAssignment_2(), "rule__TerminologyGraph__KindAssignment_2");
					put(grammarAccess.getTerminologyGraphAccess().getIriAssignment_4(), "rule__TerminologyGraph__IriAssignment_4");
					put(grammarAccess.getTerminologyGraphAccess().getBoxAxiomsAssignment_6_0(), "rule__TerminologyGraph__BoxAxiomsAssignment_6_0");
					put(grammarAccess.getTerminologyGraphAccess().getBoxStatementsAssignment_6_1(), "rule__TerminologyGraph__BoxStatementsAssignment_6_1");
					put(grammarAccess.getBundleAccess().getAnnotationPropertiesAssignment_0(), "rule__Bundle__AnnotationPropertiesAssignment_0");
					put(grammarAccess.getBundleAccess().getAnnotationsAssignment_1(), "rule__Bundle__AnnotationsAssignment_1");
					put(grammarAccess.getBundleAccess().getKindAssignment_2(), "rule__Bundle__KindAssignment_2");
					put(grammarAccess.getBundleAccess().getIriAssignment_4(), "rule__Bundle__IriAssignment_4");
					put(grammarAccess.getBundleAccess().getBoxAxiomsAssignment_6_0(), "rule__Bundle__BoxAxiomsAssignment_6_0");
					put(grammarAccess.getBundleAccess().getBoxStatementsAssignment_6_1(), "rule__Bundle__BoxStatementsAssignment_6_1");
					put(grammarAccess.getBundleAccess().getBundleStatementsAssignment_6_2(), "rule__Bundle__BundleStatementsAssignment_6_2");
					put(grammarAccess.getBundleAccess().getBundleAxiomsAssignment_6_3(), "rule__Bundle__BundleAxiomsAssignment_6_3");
					put(grammarAccess.getDescriptionBoxAccess().getAnnotationPropertiesAssignment_0(), "rule__DescriptionBox__AnnotationPropertiesAssignment_0");
					put(grammarAccess.getDescriptionBoxAccess().getAnnotationsAssignment_1(), "rule__DescriptionBox__AnnotationsAssignment_1");
					put(grammarAccess.getDescriptionBoxAccess().getKindAssignment_2(), "rule__DescriptionBox__KindAssignment_2");
					put(grammarAccess.getDescriptionBoxAccess().getIriAssignment_4(), "rule__DescriptionBox__IriAssignment_4");
					put(grammarAccess.getDescriptionBoxAccess().getClosedWorldDefinitionsAssignment_6_0(), "rule__DescriptionBox__ClosedWorldDefinitionsAssignment_6_0");
					put(grammarAccess.getDescriptionBoxAccess().getDescriptionBoxRefinementsAssignment_6_1(), "rule__DescriptionBox__DescriptionBoxRefinementsAssignment_6_1");
					put(grammarAccess.getDescriptionBoxAccess().getConceptInstancesAssignment_6_2(), "rule__DescriptionBox__ConceptInstancesAssignment_6_2");
					put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstancesAssignment_6_3(), "rule__DescriptionBox__ReifiedRelationshipInstancesAssignment_6_3");
					put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceDomainsAssignment_6_4(), "rule__DescriptionBox__ReifiedRelationshipInstanceDomainsAssignment_6_4");
					put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceRangesAssignment_6_5(), "rule__DescriptionBox__ReifiedRelationshipInstanceRangesAssignment_6_5");
					put(grammarAccess.getDescriptionBoxAccess().getUnreifiedRelationshipInstanceTuplesAssignment_6_6(), "rule__DescriptionBox__UnreifiedRelationshipInstanceTuplesAssignment_6_6");
					put(grammarAccess.getDescriptionBoxAccess().getSingletonScalarDataPropertyValuesAssignment_6_7(), "rule__DescriptionBox__SingletonScalarDataPropertyValuesAssignment_6_7");
					put(grammarAccess.getDescriptionBoxAccess().getSingletonStructuredDataPropertyValuesAssignment_6_8(), "rule__DescriptionBox__SingletonStructuredDataPropertyValuesAssignment_6_8");
					...
					put(grammarAccess.getReifiedRelationshipAccess().getForwardPropertyAssignment_7(), "rule__ReifiedRelationship__ForwardPropertyAssignment_7");
					put(grammarAccess.getReifiedRelationshipAccess().getInversePropertyAssignment_8_2(), "rule__ReifiedRelationship__InversePropertyAssignment_8_2");
					...
					put(grammarAccess.getSegmentPredicateAccess().getForwardPropertyAssignment_3_3(), "rule__SegmentPredicate__ForwardPropertyAssignment_3_3");
					put(grammarAccess.getSegmentPredicateAccess().getInversePropertyAssignment_4_5(), "rule__SegmentPredicate__InversePropertyAssignment_4_5");
					...
					put(grammarAccess.getEntityExistentialForwardReifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityExistentialForwardReifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityExistentialForwardReifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityExistentialForwardReifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityExistentialForwardReifiedRestrictionAxiomAccess().getForwardPropertyAssignment_4(), "rule__EntityExistentialForwardReifiedRestrictionAxiom__ForwardPropertyAssignment_4");
					put(grammarAccess.getEntityExistentialForwardReifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityExistentialForwardReifiedRestrictionAxiom__RestrictedRangeAssignment_6");
					put(grammarAccess.getEntityExistentialInverseReifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityExistentialInverseReifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityExistentialInverseReifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityExistentialInverseReifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityExistentialInverseReifiedRestrictionAxiomAccess().getInversePropertyAssignment_4(), "rule__EntityExistentialInverseReifiedRestrictionAxiom__InversePropertyAssignment_4");
					put(grammarAccess.getEntityExistentialInverseReifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityExistentialInverseReifiedRestrictionAxiom__RestrictedRangeAssignment_6");
					put(grammarAccess.getEntityExistentialUnreifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityExistentialUnreifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityExistentialUnreifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityExistentialUnreifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityExistentialUnreifiedRestrictionAxiomAccess().getRestrictedUnreifiedRelationshipAssignment_4(), "rule__EntityExistentialUnreifiedRestrictionAxiom__RestrictedUnreifiedRelationshipAssignment_4");
					put(grammarAccess.getEntityExistentialUnreifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityExistentialUnreifiedRestrictionAxiom__RestrictedRangeAssignment_6");
					put(grammarAccess.getEntityUniversalForwardReifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityUniversalForwardReifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityUniversalForwardReifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityUniversalForwardReifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityUniversalForwardReifiedRestrictionAxiomAccess().getForwardPropertyAssignment_4(), "rule__EntityUniversalForwardReifiedRestrictionAxiom__ForwardPropertyAssignment_4");
					put(grammarAccess.getEntityUniversalForwardReifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityUniversalForwardReifiedRestrictionAxiom__RestrictedRangeAssignment_6");
					put(grammarAccess.getEntityUniversalInverseReifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityUniversalInverseReifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityUniversalInverseReifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityUniversalInverseReifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityUniversalInverseReifiedRestrictionAxiomAccess().getInversePropertyAssignment_4(), "rule__EntityUniversalInverseReifiedRestrictionAxiom__InversePropertyAssignment_4");
					put(grammarAccess.getEntityUniversalInverseReifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityUniversalInverseReifiedRestrictionAxiom__RestrictedRangeAssignment_6");
					put(grammarAccess.getEntityUniversalUnreifiedRestrictionAxiomAccess().getAnnotationsAssignment_0(), "rule__EntityUniversalUnreifiedRestrictionAxiom__AnnotationsAssignment_0");
					put(grammarAccess.getEntityUniversalUnreifiedRestrictionAxiomAccess().getRestrictedDomainAssignment_2(), "rule__EntityUniversalUnreifiedRestrictionAxiom__RestrictedDomainAssignment_2");
					put(grammarAccess.getEntityUniversalUnreifiedRestrictionAxiomAccess().getRestrictedUnreifiedRelationshipAssignment_4(), "rule__EntityUniversalUnreifiedRestrictionAxiom__RestrictedUnreifiedRelationshipAssignment_4");
					put(grammarAccess.getEntityUniversalUnreifiedRestrictionAxiomAccess().getRestrictedRangeAssignment_6(), "rule__EntityUniversalUnreifiedRestrictionAxiom__RestrictedRangeAssignment_6");
