...
public class OMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstancesAssignment_6_3(), "rule__DescriptionBox__ReifiedRelationshipInstancesAssignment_6_3");
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceDomainsAssignment_6_4(), "rule__DescriptionBox__ReifiedRelationshipInstanceDomainsAssignment_6_4");
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceRangesAssignment_6_5(), "rule__DescriptionBox__ReifiedRelationshipInstanceRangesAssignment_6_5");
			builder.put(grammarAccess.getDescriptionBoxAccess().getUnreifiedRelationshipInstanceTuplesAssignment_6_6(), "rule__DescriptionBox__UnreifiedRelationshipInstanceTuplesAssignment_6_6");
			builder.put(grammarAccess.getDescriptionBoxAccess().getSingletonScalarDataPropertyValuesAssignment_6_7(), "rule__DescriptionBox__SingletonScalarDataPropertyValuesAssignment_6_7");
			builder.put(grammarAccess.getDescriptionBoxAccess().getSingletonStructuredDataPropertyValuesAssignment_6_8(), "rule__DescriptionBox__SingletonStructuredDataPropertyValuesAssignment_6_8");
