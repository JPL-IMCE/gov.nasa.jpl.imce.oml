...
public class OMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInstanceRelationshipEnumerationRestrictionAccess().getGroup(), "rule__InstanceRelationshipEnumerationRestriction__Group__0");
			builder.put(grammarAccess.getInstanceRelationshipOneOfRestrictionAccess().getGroup(), "rule__InstanceRelationshipOneOfRestriction__Group__0");
			...
			builder.put(grammarAccess.getDescriptionBoxAccess().getInstanceRelationshipEnumerationRestrictionsAssignment_6_3(), "rule__DescriptionBox__InstanceRelationshipEnumerationRestrictionsAssignment_6_3");
			builder.put(grammarAccess.getDescriptionBoxAccess().getInstanceRelationshipValueRestrictionsAssignment_6_4(), "rule__DescriptionBox__InstanceRelationshipValueRestrictionsAssignment_6_4");
			builder.put(grammarAccess.getDescriptionBoxAccess().getInstanceRelationshipExistentialRangeRestrictionsAssignment_6_5(), "rule__DescriptionBox__InstanceRelationshipExistentialRangeRestrictionsAssignment_6_5");
			builder.put(grammarAccess.getDescriptionBoxAccess().getInstanceRelationshipUniversalRangeRestrictionsAssignment_6_6(), "rule__DescriptionBox__InstanceRelationshipUniversalRangeRestrictionsAssignment_6_6");
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstancesAssignment_6_7(), "rule__DescriptionBox__ReifiedRelationshipInstancesAssignment_6_7");
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceDomainsAssignment_6_8(), "rule__DescriptionBox__ReifiedRelationshipInstanceDomainsAssignment_6_8");
			builder.put(grammarAccess.getDescriptionBoxAccess().getReifiedRelationshipInstanceRangesAssignment_6_9(), "rule__DescriptionBox__ReifiedRelationshipInstanceRangesAssignment_6_9");
			builder.put(grammarAccess.getDescriptionBoxAccess().getUnreifiedRelationshipInstanceTuplesAssignment_6_10(), "rule__DescriptionBox__UnreifiedRelationshipInstanceTuplesAssignment_6_10");
			builder.put(grammarAccess.getDescriptionBoxAccess().getSingletonScalarDataPropertyValuesAssignment_6_11(), "rule__DescriptionBox__SingletonScalarDataPropertyValuesAssignment_6_11");
			builder.put(grammarAccess.getDescriptionBoxAccess().getSingletonStructuredDataPropertyValuesAssignment_6_12(), "rule__DescriptionBox__SingletonStructuredDataPropertyValuesAssignment_6_12");
			...
			builder.put(grammarAccess.getInstanceRelationshipEnumerationRestrictionAccess().getAnnotationsAssignment_0(), "rule__InstanceRelationshipEnumerationRestriction__AnnotationsAssignment_0");
			builder.put(grammarAccess.getInstanceRelationshipEnumerationRestrictionAccess().getDomainAssignment_1(), "rule__InstanceRelationshipEnumerationRestriction__DomainAssignment_1");
			builder.put(grammarAccess.getInstanceRelationshipEnumerationRestrictionAccess().getRestrictedRelationshipAssignment_3(), "rule__InstanceRelationshipEnumerationRestriction__RestrictedRelationshipAssignment_3");
			builder.put(grammarAccess.getInstanceRelationshipEnumerationRestrictionAccess().getReferencesAssignment_6(), "rule__InstanceRelationshipEnumerationRestriction__ReferencesAssignment_6");
			builder.put(grammarAccess.getInstanceRelationshipOneOfRestrictionAccess().getAnnotationsAssignment_0(), "rule__InstanceRelationshipOneOfRestriction__AnnotationsAssignment_0");
			builder.put(grammarAccess.getInstanceRelationshipOneOfRestrictionAccess().getRangeAssignment_1(), "rule__InstanceRelationshipOneOfRestriction__RangeAssignment_1");
