		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCardinalityRestrictionKindAccess().getAlternatives(), "rule__CardinalityRestrictionKind__Alternatives");
					...
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getGroup(), "rule__CardinalityRestrictedAspect__Group__0");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getGroup_6(), "rule__CardinalityRestrictedAspect__Group_6__0");
					put(grammarAccess.getConceptAccess().getGroup(), "rule__Concept__Group__0");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getGroup(), "rule__CardinalityRestrictedConcept__Group__0");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getGroup_6(), "rule__CardinalityRestrictedConcept__Group_6__0");
					...
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getGroup(), "rule__CardinalityRestrictedReifiedRelationship__Group__0");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getGroup_6(), "rule__CardinalityRestrictedReifiedRelationship__Group_6__0");
					...
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getAnnotationsAssignment_0(), "rule__CardinalityRestrictedAspect__AnnotationsAssignment_0");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getNameAssignment_2(), "rule__CardinalityRestrictedAspect__NameAssignment_2");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getRestrictionKindAssignment_3(), "rule__CardinalityRestrictedAspect__RestrictionKindAssignment_3");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getRestrictedCardinalityAssignment_4(), "rule__CardinalityRestrictedAspect__RestrictedCardinalityAssignment_4");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getRestrictedRelationshipAssignment_5(), "rule__CardinalityRestrictedAspect__RestrictedRelationshipAssignment_5");
					put(grammarAccess.getCardinalityRestrictedAspectAccess().getRestrictedRangeAssignment_6_1(), "rule__CardinalityRestrictedAspect__RestrictedRangeAssignment_6_1");
					...
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getAnnotationsAssignment_0(), "rule__CardinalityRestrictedConcept__AnnotationsAssignment_0");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getNameAssignment_2(), "rule__CardinalityRestrictedConcept__NameAssignment_2");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getRestrictionKindAssignment_3(), "rule__CardinalityRestrictedConcept__RestrictionKindAssignment_3");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getRestrictedCardinalityAssignment_4(), "rule__CardinalityRestrictedConcept__RestrictedCardinalityAssignment_4");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getRestrictedRelationshipAssignment_5(), "rule__CardinalityRestrictedConcept__RestrictedRelationshipAssignment_5");
					put(grammarAccess.getCardinalityRestrictedConceptAccess().getRestrictedRangeAssignment_6_1(), "rule__CardinalityRestrictedConcept__RestrictedRangeAssignment_6_1");
					...
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getAnnotationsAssignment_0(), "rule__CardinalityRestrictedReifiedRelationship__AnnotationsAssignment_0");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getNameAssignment_2(), "rule__CardinalityRestrictedReifiedRelationship__NameAssignment_2");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getRestrictionKindAssignment_3(), "rule__CardinalityRestrictedReifiedRelationship__RestrictionKindAssignment_3");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getRestrictedCardinalityAssignment_4(), "rule__CardinalityRestrictedReifiedRelationship__RestrictedCardinalityAssignment_4");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getRestrictedRelationshipAssignment_5(), "rule__CardinalityRestrictedReifiedRelationship__RestrictedRelationshipAssignment_5");
					put(grammarAccess.getCardinalityRestrictedReifiedRelationshipAccess().getRestrictedRangeAssignment_6_1(), "rule__CardinalityRestrictedReifiedRelationship__RestrictedRangeAssignment_6_1");
					...
					put(grammarAccess.getSegmentPredicateAccess().getPredicateAssignment_0(), "rule__SegmentPredicate__PredicateAssignment_0");
					put(grammarAccess.getSegmentPredicateAccess().getReifiedRelationshipSourceAssignment_1_2(), "rule__SegmentPredicate__ReifiedRelationshipSourceAssignment_1_2");
					put(grammarAccess.getSegmentPredicateAccess().getReifiedRelationshipInverseSourceAssignment_2_2(), "rule__SegmentPredicate__ReifiedRelationshipInverseSourceAssignment_2_2");
					put(grammarAccess.getSegmentPredicateAccess().getReifiedRelationshipTargetAssignment_3_2(), "rule__SegmentPredicate__ReifiedRelationshipTargetAssignment_3_2");
					put(grammarAccess.getSegmentPredicateAccess().getReifiedRelationshipInverseTargetAssignment_4_2(), "rule__SegmentPredicate__ReifiedRelationshipInverseTargetAssignment_4_2");
					put(grammarAccess.getSegmentPredicateAccess().getUnreifiedRelationshipInverseAssignment_5_2(), "rule__SegmentPredicate__UnreifiedRelationshipInverseAssignment_5_2");
					...
					put(grammarAccess.getEntityExistentialRestrictionAxiomAccess().getRestrictedRelationshipAssignment_4(), "rule__EntityExistentialRestrictionAxiom__RestrictedRelationshipAssignment_4");
					...
					put(grammarAccess.getEntityUniversalRestrictionAxiomAccess().getRestrictedRelationshipAssignment_4(), "rule__EntityUniversalRestrictionAxiom__RestrictedRelationshipAssignment_4");
